...
commandType avB17221AECPAEMMessage  =
    fmap (AVB17221AEMCommandType . fromIntegral :: CUInt -> AVB17221AEMCommandType) $ sendMsg avB17221AECPAEMMessage (mkSelector "commandType") retCUInt []
...
setCommandType avB17221AECPAEMMessage  value =
    sendMsg avB17221AECPAEMMessage (mkSelector "setCommandType:") retVoid [argCUInt (fromIntegral (coerce value :: CUShort))]
