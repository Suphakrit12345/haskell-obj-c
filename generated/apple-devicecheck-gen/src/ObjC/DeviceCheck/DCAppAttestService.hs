...
generateKeyWithCompletionHandler dcAppAttestService  completionHandler =
    sendMsg dcAppAttestService (mkSelector "generateKeyWithCompletionHandler:") retVoid [argPtr (castPtr completionHandler :: Ptr ())]
...
attestKey_clientDataHash_completionHandler dcAppAttestService  keyId clientDataHash completionHandler =
  withObjCPtr keyId $ \raw_keyId ->
    withObjCPtr clientDataHash $ \raw_clientDataHash ->
        sendMsg dcAppAttestService (mkSelector "attestKey:clientDataHash:completionHandler:") retVoid [argPtr (castPtr raw_keyId :: Ptr ()), argPtr (castPtr raw_clientDataHash :: Ptr ()), argPtr (castPtr completionHandler :: Ptr ())]
...
generateAssertion_clientDataHash_completionHandler dcAppAttestService  keyId clientDataHash completionHandler =
  withObjCPtr keyId $ \raw_keyId ->
    withObjCPtr clientDataHash $ \raw_clientDataHash ->
        sendMsg dcAppAttestService (mkSelector "generateAssertion:clientDataHash:completionHandler:") retVoid [argPtr (castPtr raw_keyId :: Ptr ()), argPtr (castPtr raw_clientDataHash :: Ptr ()), argPtr (castPtr completionHandler :: Ptr ())]
...
sharedService  =
  do
    ...
    sendClassMsg cls' (mkSelector "sharedService") (retPtr retVoid) [] >>= retainedObject . castPtr
...
supported dcAppAttestService  =
    fmap ((/= 0) :: CULong -> Bool) $ sendMsg dcAppAttestService (mkSelector "supported") retCULong []
...
generateKeyWithCompletionHandlerSelector :: Selector
...
attestKey_clientDataHash_completionHandlerSelector :: Selector
...
generateAssertion_clientDataHash_completionHandlerSelector :: Selector
...
sharedServiceSelector :: Selector
