...
setStrokeStart mkPolylineRenderer  value =
    sendMsg mkPolylineRenderer (mkSelector "setStrokeStart:") retVoid [argCDouble value]
...
setStrokeEnd mkPolylineRenderer  value =
    sendMsg mkPolylineRenderer (mkSelector "setStrokeEnd:") retVoid [argCDouble value]
