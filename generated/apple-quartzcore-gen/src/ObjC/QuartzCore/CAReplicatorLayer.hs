...
setInstanceCount caReplicatorLayer  value =
    sendMsg caReplicatorLayer (mkSelector "setInstanceCount:") retVoid [argCLong value]
...
setInstanceDelay caReplicatorLayer  value =
    sendMsg caReplicatorLayer (mkSelector "setInstanceDelay:") retVoid [argCDouble value]
...
setInstanceRedOffset caReplicatorLayer  value =
    sendMsg caReplicatorLayer (mkSelector "setInstanceRedOffset:") retVoid [argCFloat value]
...
setInstanceGreenOffset caReplicatorLayer  value =
    sendMsg caReplicatorLayer (mkSelector "setInstanceGreenOffset:") retVoid [argCFloat value]
...
setInstanceBlueOffset caReplicatorLayer  value =
    sendMsg caReplicatorLayer (mkSelector "setInstanceBlueOffset:") retVoid [argCFloat value]
...
setInstanceAlphaOffset caReplicatorLayer  value =
    sendMsg caReplicatorLayer (mkSelector "setInstanceAlphaOffset:") retVoid [argCFloat value]
