...
setFrameInterval caDisplayLink  value =
    sendMsg caDisplayLink (mkSelector "setFrameInterval:") retVoid [argCLong value]
...
setPreferredFramesPerSecond caDisplayLink  value =
    sendMsg caDisplayLink (mkSelector "setPreferredFramesPerSecond:") retVoid [argCLong value]
