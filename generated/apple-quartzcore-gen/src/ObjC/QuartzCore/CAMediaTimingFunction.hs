...
functionWithControlPoints c1x c1y c2x c2y =
  do
    cls' <- getRequiredClass "CAMediaTimingFunction"
    sendClassMsg cls' (mkSelector "functionWithControlPoints::::") (retPtr retVoid) [argCFloat c1x, argCFloat c1y, argCFloat c2x, argCFloat c2y] >>= retainedObject . castPtr
...
initWithControlPoints caMediaTimingFunction  c1x c1y c2x c2y =
    sendMsg caMediaTimingFunction (mkSelector "initWithControlPoints::::") (retPtr retVoid) [argCFloat c1x, argCFloat c1y, argCFloat c2x, argCFloat c2y] >>= ownedObject . castPtr
...
getControlPointAtIndex_values caMediaTimingFunction  idx ptr =
    sendMsg caMediaTimingFunction (mkSelector "getControlPointAtIndex:values:") retVoid [argCULong idx, argPtr ptr]
