...
setBirthRate caEmitterLayer  value =
    sendMsg caEmitterLayer (mkSelector "setBirthRate:") retVoid [argCFloat value]
...
setLifetime caEmitterLayer  value =
    sendMsg caEmitterLayer (mkSelector "setLifetime:") retVoid [argCFloat value]
...
setEmitterZPosition caEmitterLayer  value =
    sendMsg caEmitterLayer (mkSelector "setEmitterZPosition:") retVoid [argCDouble value]
...
setEmitterDepth caEmitterLayer  value =
    sendMsg caEmitterLayer (mkSelector "setEmitterDepth:") retVoid [argCDouble value]
...
setVelocity caEmitterLayer  value =
    sendMsg caEmitterLayer (mkSelector "setVelocity:") retVoid [argCFloat value]
...
setScale caEmitterLayer  value =
    sendMsg caEmitterLayer (mkSelector "setScale:") retVoid [argCFloat value]
...
setSpin caEmitterLayer  value =
    sendMsg caEmitterLayer (mkSelector "setSpin:") retVoid [argCFloat value]
...
setSeed caEmitterLayer  value =
    sendMsg caEmitterLayer (mkSelector "setSeed:") retVoid [argCUInt value]
