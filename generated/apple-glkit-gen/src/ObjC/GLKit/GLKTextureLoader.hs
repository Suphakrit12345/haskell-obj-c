  ...
  do
    ...
    withObjCPtr name $ \raw_name ->
      withObjCPtr bundle $ \raw_bundle ->
        withObjCPtr options $ \raw_options ->
          withObjCPtr outError $ \raw_outError ->
            sendClassMsg cls' (mkSelector "textureWithName:scaleFactor:bundle:options:error:") (retPtr retVoid) [argPtr (castPtr raw_name :: Ptr ()), argCDouble scaleFactor, argPtr (castPtr raw_bundle :: Ptr ()), argPtr (castPtr raw_options :: Ptr ()), argPtr (castPtr raw_outError :: Ptr ())] >>= retainedObject . castPtr
...
textureWithName_scaleFactor_bundle_options_queue_completionHandler glkTextureLoader  name scaleFactor bundle options queue block =
  withObjCPtr name $ \raw_name ->
    withObjCPtr bundle $ \raw_bundle ->
      withObjCPtr options $ \raw_options ->
        withObjCPtr queue $ \raw_queue ->
            sendMsg glkTextureLoader (mkSelector "textureWithName:scaleFactor:bundle:options:queue:completionHandler:") retVoid [argPtr (castPtr raw_name :: Ptr ()), argCDouble scaleFactor, argPtr (castPtr raw_bundle :: Ptr ()), argPtr (castPtr raw_options :: Ptr ()), argPtr (castPtr raw_queue :: Ptr ()), argPtr (castPtr block :: Ptr ())]
