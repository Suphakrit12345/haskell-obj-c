...
setColorMaterialEnabled glkBaseEffect  value =
    sendMsg glkBaseEffect (mkSelector "setColorMaterialEnabled:") retVoid [argCUChar value]
...
setLightModelTwoSided glkBaseEffect  value =
    sendMsg glkBaseEffect (mkSelector "setLightModelTwoSided:") retVoid [argCUChar value]
...
setUseConstantColor glkBaseEffect  value =
    sendMsg glkBaseEffect (mkSelector "setUseConstantColor:") retVoid [argCUChar value]
