...
attributesAtIndex_effectiveRange nsAttributedString  location range =
    sendMsg nsAttributedString (mkSelector "attributesAtIndex:effectiveRange:") (retPtr retVoid) [argCULong location, argPtr range] >>= retainedObject . castPtr
...
attribute_atIndex_effectiveRange nsAttributedString  attrName location range =
  withObjCPtr attrName $ \raw_attrName ->
      fmap (RawId . castPtr) $ sendMsg nsAttributedString (mkSelector "attribute:atIndex:effectiveRange:") (retPtr retVoid) [argPtr (castPtr raw_attrName :: Ptr ()), argCULong location, argPtr range]
...
attributesAtIndex_longestEffectiveRange_inRange nsAttributedString  location range rangeLimit =
    sendMsg nsAttributedString (mkSelector "attributesAtIndex:longestEffectiveRange:inRange:") (retPtr retVoid) [argCULong location, argPtr range, argNSRange rangeLimit] >>= retainedObject . castPtr
...
attribute_atIndex_longestEffectiveRange_inRange nsAttributedString  attrName location range rangeLimit =
  withObjCPtr attrName $ \raw_attrName ->
      fmap (RawId . castPtr) $ sendMsg nsAttributedString (mkSelector "attribute:atIndex:longestEffectiveRange:inRange:") (retPtr retVoid) [argPtr (castPtr raw_attrName :: Ptr ()), argCULong location, argPtr range, argNSRange rangeLimit]
