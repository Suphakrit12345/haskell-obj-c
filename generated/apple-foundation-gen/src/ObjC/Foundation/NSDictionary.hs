...
initWithObjects_forKeys_count nsDictionary  objects keys cnt =
    sendMsg nsDictionary (mkSelector "initWithObjects:forKeys:count:") (retPtr retVoid) [argPtr (castPtr (unRawId objects) :: Ptr ()), argPtr (castPtr (unRawId keys) :: Ptr ()), argCULong cnt] >>= ownedObject . castPtr
...
countByEnumeratingWithState_objects_count nsDictionary  state buffer len =
    sendMsg nsDictionary (mkSelector "countByEnumeratingWithState:objects:count:") retCULong [argPtr state, argPtr (castPtr (unRawId buffer) :: Ptr ()), argCULong len]
...
dictionaryWithObjects_forKeys_count objects keys cnt =
  do
    cls' <- getRequiredClass "NSDictionary"
    sendClassMsg cls' (mkSelector "dictionaryWithObjects:forKeys:count:") (retPtr retVoid) [argPtr (castPtr (unRawId objects) :: Ptr ()), argPtr (castPtr (unRawId keys) :: Ptr ()), argCULong cnt] >>= retainedObject . castPtr
...
descriptionWithLocale_indent nsDictionary  locale level =
    sendMsg nsDictionary (mkSelector "descriptionWithLocale:indent:") (retPtr retVoid) [argPtr (castPtr (unRawId locale) :: Ptr ()), argCULong level] >>= retainedObject . castPtr
...
getObjects_andKeys_count nsDictionary  objects keys count =
    sendMsg nsDictionary (mkSelector "getObjects:andKeys:count:") retVoid [argPtr (castPtr (unRawId objects) :: Ptr ()), argPtr (castPtr (unRawId keys) :: Ptr ()), argCULong count]
