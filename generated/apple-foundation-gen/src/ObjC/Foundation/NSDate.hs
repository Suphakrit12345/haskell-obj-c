...
initWithTimeIntervalSinceReferenceDate nsDate  ti =
    sendMsg nsDate (mkSelector "initWithTimeIntervalSinceReferenceDate:") (retPtr retVoid) [argCDouble ti] >>= ownedObject . castPtr
...
dateWithTimeIntervalSinceNow secs =
  do
    cls' <- getRequiredClass "NSDate"
    sendClassMsg cls' (mkSelector "dateWithTimeIntervalSinceNow:") (retPtr retVoid) [argCDouble secs] >>= retainedObject . castPtr
...
dateWithTimeIntervalSinceReferenceDate ti =
  do
    cls' <- getRequiredClass "NSDate"
    sendClassMsg cls' (mkSelector "dateWithTimeIntervalSinceReferenceDate:") (retPtr retVoid) [argCDouble ti] >>= retainedObject . castPtr
...
dateWithTimeIntervalSince1970 secs =
  do
    cls' <- getRequiredClass "NSDate"
    sendClassMsg cls' (mkSelector "dateWithTimeIntervalSince1970:") (retPtr retVoid) [argCDouble secs] >>= retainedObject . castPtr
...
dateWithTimeInterval_sinceDate secsToBeAdded date =
  do
    ...
    withObjCPtr date $ \raw_date ->
      sendClassMsg cls' (mkSelector "dateWithTimeInterval:sinceDate:") (retPtr retVoid) [argCDouble secsToBeAdded, argPtr (castPtr raw_date :: Ptr ())] >>= retainedObject . castPtr

-- | @- initWithTimeIntervalSinceNow:@
initWithTimeIntervalSinceNow :: IsNSDate nsDate => nsDate -> CDouble -> IO (Id NSDate)
initWithTimeIntervalSinceNow nsDate  secs =
    sendMsg nsDate (mkSelector "initWithTimeIntervalSinceNow:") (retPtr retVoid) [argCDouble secs] >>= ownedObject . castPtr

-- | @- initWithTimeIntervalSince1970:@
initWithTimeIntervalSince1970 :: IsNSDate nsDate => nsDate -> CDouble -> IO (Id NSDate)
initWithTimeIntervalSince1970 nsDate  secs =
    sendMsg nsDate (mkSelector "initWithTimeIntervalSince1970:") (retPtr retVoid) [argCDouble secs] >>= ownedObject . castPtr
...
initWithTimeInterval_sinceDate nsDate  secsToBeAdded date =
  withObjCPtr date $ \raw_date ->
      sendMsg nsDate (mkSelector "initWithTimeInterval:sinceDate:") (retPtr retVoid) [argCDouble secsToBeAdded, argPtr (castPtr raw_date :: Ptr ())] >>= ownedObject . castPtr
...
addTimeInterval nsDate  seconds =
    fmap (RawId . castPtr) $ sendMsg nsDate (mkSelector "addTimeInterval:") (retPtr retVoid) [argCDouble seconds]

-- | @- dateByAddingTimeInterval:@
dateByAddingTimeInterval :: IsNSDate nsDate => nsDate -> CDouble -> IO (Id NSDate)
dateByAddingTimeInterval nsDate  ti =
    sendMsg nsDate (mkSelector "dateByAddingTimeInterval:") (retPtr retVoid) [argCDouble ti] >>= retainedObject . castPtr
