...
setInteger_forKey nsUserDefaults  value defaultName =
  withObjCPtr defaultName $ \raw_defaultName ->
      sendMsg nsUserDefaults (mkSelector "setInteger:forKey:") retVoid [argCLong value, argPtr (castPtr raw_defaultName :: Ptr ())]
...
setFloat_forKey nsUserDefaults  value defaultName =
  withObjCPtr defaultName $ \raw_defaultName ->
      sendMsg nsUserDefaults (mkSelector "setFloat:forKey:") retVoid [argCFloat value, argPtr (castPtr raw_defaultName :: Ptr ())]
...
setDouble_forKey nsUserDefaults  value defaultName =
  withObjCPtr defaultName $ \raw_defaultName ->
      sendMsg nsUserDefaults (mkSelector "setDouble:forKey:") retVoid [argCDouble value, argPtr (castPtr raw_defaultName :: Ptr ())]
