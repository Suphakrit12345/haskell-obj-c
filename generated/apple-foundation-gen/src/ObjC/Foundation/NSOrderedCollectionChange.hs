...
changeWithObject_type_index anObject type_ index =
  do
    ...
    sendClassMsg cls' (mkSelector "changeWithObject:type:index:") (retPtr retVoid) [argPtr (castPtr (unRawId anObject) :: Ptr ()), argCLong (coerce type_), argCULong index] >>= retainedObject . castPtr
...
changeWithObject_type_index_associatedIndex anObject type_ index associatedIndex =
  do
    cls' <- getRequiredClass "NSOrderedCollectionChange"
    sendClassMsg cls' (mkSelector "changeWithObject:type:index:associatedIndex:") (retPtr retVoid) [argPtr (castPtr (unRawId anObject) :: Ptr ()), argCLong (coerce type_), argCULong index, argCULong associatedIndex] >>= retainedObject . castPtr
...
initWithObject_type_index nsOrderedCollectionChange  anObject type_ index =
    sendMsg nsOrderedCollectionChange (mkSelector "initWithObject:type:index:") (retPtr retVoid) [argPtr (castPtr (unRawId anObject) :: Ptr ()), argCLong (coerce type_), argCULong index] >>= ownedObject . castPtr
...
initWithObject_type_index_associatedIndex nsOrderedCollectionChange  anObject type_ index associatedIndex =
    sendMsg nsOrderedCollectionChange (mkSelector "initWithObject:type:index:associatedIndex:") (retPtr retVoid) [argPtr (castPtr (unRawId anObject) :: Ptr ()), argCLong (coerce type_), argCULong index, argCULong associatedIndex] >>= ownedObject . castPtr
