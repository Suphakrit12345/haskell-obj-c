...
translateXBy_yBy nsAffineTransform  deltaX deltaY =
    sendMsg nsAffineTransform (mkSelector "translateXBy:yBy:") retVoid [argCDouble deltaX, argCDouble deltaY]
...
rotateByDegrees nsAffineTransform  angle =
    sendMsg nsAffineTransform (mkSelector "rotateByDegrees:") retVoid [argCDouble angle]
...
rotateByRadians nsAffineTransform  angle =
    sendMsg nsAffineTransform (mkSelector "rotateByRadians:") retVoid [argCDouble angle]

-- | @- scaleBy:@
scaleBy :: IsNSAffineTransform nsAffineTransform => nsAffineTransform -> CDouble -> IO ()
scaleBy nsAffineTransform  scale =
    sendMsg nsAffineTransform (mkSelector "scaleBy:") retVoid [argCDouble scale]
...
scaleXBy_yBy nsAffineTransform  scaleX scaleY =
    sendMsg nsAffineTransform (mkSelector "scaleXBy:yBy:") retVoid [argCDouble scaleX, argCDouble scaleY]
