...
dateWithYear_month_day_hour_minute_second_timeZone year month day hour minute second aTimeZone =
  do
    ...
    withObjCPtr aTimeZone $ \raw_aTimeZone ->
      fmap (RawId . castPtr) $ sendClassMsg cls' (mkSelector "dateWithYear:month:day:hour:minute:second:timeZone:") (retPtr retVoid) [argCLong year, argCULong month, argCULong day, argCULong hour, argCULong minute, argCULong second, argPtr (castPtr raw_aTimeZone :: Ptr ())]
...
dateByAddingYears_months_days_hours_minutes_seconds nsCalendarDate  year month day hour minute second =
    sendMsg nsCalendarDate (mkSelector "dateByAddingYears:months:days:hours:minutes:seconds:") (retPtr retVoid) [argCLong year, argCLong month, argCLong day, argCLong hour, argCLong minute, argCLong second] >>= retainedObject . castPtr
...
initWithYear_month_day_hour_minute_second_timeZone nsCalendarDate  year month day hour minute second aTimeZone =
  withObjCPtr aTimeZone $ \raw_aTimeZone ->
      fmap (RawId . castPtr) $ sendMsg nsCalendarDate (mkSelector "initWithYear:month:day:hour:minute:second:timeZone:") (retPtr retVoid) [argCLong year, argCULong month, argCULong day, argCULong hour, argCULong minute, argCULong second, argPtr (castPtr raw_aTimeZone :: Ptr ())]
