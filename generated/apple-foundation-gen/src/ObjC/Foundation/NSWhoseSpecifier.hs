...
setStartSubelementIndex nsWhoseSpecifier  value =
    sendMsg nsWhoseSpecifier (mkSelector "setStartSubelementIndex:") retVoid [argCLong value]
...
setEndSubelementIndex nsWhoseSpecifier  value =
    sendMsg nsWhoseSpecifier (mkSelector "setEndSubelementIndex:") retVoid [argCLong value]
