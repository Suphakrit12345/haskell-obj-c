...
setLongLong_forKey nsUbiquitousKeyValueStore  value aKey =
  withObjCPtr aKey $ \raw_aKey ->
      sendMsg nsUbiquitousKeyValueStore (mkSelector "setLongLong:forKey:") retVoid [argCLong value, argPtr (castPtr raw_aKey :: Ptr ())]
...
setDouble_forKey nsUbiquitousKeyValueStore  value aKey =
  withObjCPtr aKey $ \raw_aKey ->
      sendMsg nsUbiquitousKeyValueStore (mkSelector "setDouble:forKey:") retVoid [argCDouble value, argPtr (castPtr raw_aKey :: Ptr ())]
