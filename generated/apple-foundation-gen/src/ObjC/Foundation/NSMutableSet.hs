...
initWithCapacity nsMutableSet  numItems =
    sendMsg nsMutableSet (mkSelector "initWithCapacity:") (retPtr retVoid) [argCULong numItems] >>= ownedObject . castPtr
...
setWithCapacity numItems =
  do
    ...
    sendClassMsg cls' (mkSelector "setWithCapacity:") (retPtr retVoid) [argCULong numItems] >>= retainedObject . castPtr
