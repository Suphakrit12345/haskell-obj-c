...
initWithChar nsNumber  value =
    sendMsg nsNumber (mkSelector "initWithChar:") (retPtr retVoid) [argCChar value] >>= ownedObject . castPtr

-- | @- initWithUnsignedChar:@
initWithUnsignedChar :: IsNSNumber nsNumber => nsNumber -> CUChar -> IO (Id NSNumber)
initWithUnsignedChar nsNumber  value =
    sendMsg nsNumber (mkSelector "initWithUnsignedChar:") (retPtr retVoid) [argCUChar value] >>= ownedObject . castPtr
...
initWithInt nsNumber  value =
    sendMsg nsNumber (mkSelector "initWithInt:") (retPtr retVoid) [argCInt value] >>= ownedObject . castPtr

-- | @- initWithUnsignedInt:@
initWithUnsignedInt :: IsNSNumber nsNumber => nsNumber -> CUInt -> IO (Id NSNumber)
initWithUnsignedInt nsNumber  value =
    sendMsg nsNumber (mkSelector "initWithUnsignedInt:") (retPtr retVoid) [argCUInt value] >>= ownedObject . castPtr

-- | @- initWithLong:@
initWithLong :: IsNSNumber nsNumber => nsNumber -> CLong -> IO (Id NSNumber)
initWithLong nsNumber  value =
    sendMsg nsNumber (mkSelector "initWithLong:") (retPtr retVoid) [argCLong value] >>= ownedObject . castPtr

-- | @- initWithUnsignedLong:@
initWithUnsignedLong :: IsNSNumber nsNumber => nsNumber -> CULong -> IO (Id NSNumber)
initWithUnsignedLong nsNumber  value =
    sendMsg nsNumber (mkSelector "initWithUnsignedLong:") (retPtr retVoid) [argCULong value] >>= ownedObject . castPtr

-- | @- initWithLongLong:@
initWithLongLong :: IsNSNumber nsNumber => nsNumber -> CLong -> IO (Id NSNumber)
initWithLongLong nsNumber  value =
    sendMsg nsNumber (mkSelector "initWithLongLong:") (retPtr retVoid) [argCLong value] >>= ownedObject . castPtr

-- | @- initWithUnsignedLongLong:@
initWithUnsignedLongLong :: IsNSNumber nsNumber => nsNumber -> CULong -> IO (Id NSNumber)
initWithUnsignedLongLong nsNumber  value =
    sendMsg nsNumber (mkSelector "initWithUnsignedLongLong:") (retPtr retVoid) [argCULong value] >>= ownedObject . castPtr

-- | @- initWithFloat:@
initWithFloat :: IsNSNumber nsNumber => nsNumber -> CFloat -> IO (Id NSNumber)
initWithFloat nsNumber  value =
    sendMsg nsNumber (mkSelector "initWithFloat:") (retPtr retVoid) [argCFloat value] >>= ownedObject . castPtr

-- | @- initWithDouble:@
initWithDouble :: IsNSNumber nsNumber => nsNumber -> CDouble -> IO (Id NSNumber)
initWithDouble nsNumber  value =
    sendMsg nsNumber (mkSelector "initWithDouble:") (retPtr retVoid) [argCDouble value] >>= ownedObject . castPtr
...
initWithInteger nsNumber  value =
    sendMsg nsNumber (mkSelector "initWithInteger:") (retPtr retVoid) [argCLong value] >>= ownedObject . castPtr

-- | @- initWithUnsignedInteger:@
initWithUnsignedInteger :: IsNSNumber nsNumber => nsNumber -> CULong -> IO (Id NSNumber)
initWithUnsignedInteger nsNumber  value =
    sendMsg nsNumber (mkSelector "initWithUnsignedInteger:") (retPtr retVoid) [argCULong value] >>= ownedObject . castPtr
...
numberWithChar value =
  do
    ...
    sendClassMsg cls' (mkSelector "numberWithChar:") (retPtr retVoid) [argCChar value] >>= retainedObject . castPtr
...
numberWithUnsignedChar value =
  do
    cls' <- getRequiredClass "NSNumber"
    sendClassMsg cls' (mkSelector "numberWithUnsignedChar:") (retPtr retVoid) [argCUChar value] >>= retainedObject . castPtr
...
numberWithInt value =
  do
    cls' <- getRequiredClass "NSNumber"
    sendClassMsg cls' (mkSelector "numberWithInt:") (retPtr retVoid) [argCInt value] >>= retainedObject . castPtr
...
numberWithUnsignedInt value =
  do
    cls' <- getRequiredClass "NSNumber"
    sendClassMsg cls' (mkSelector "numberWithUnsignedInt:") (retPtr retVoid) [argCUInt value] >>= retainedObject . castPtr
...
numberWithLong value =
  do
    cls' <- getRequiredClass "NSNumber"
    sendClassMsg cls' (mkSelector "numberWithLong:") (retPtr retVoid) [argCLong value] >>= retainedObject . castPtr
...
numberWithUnsignedLong value =
  do
    cls' <- getRequiredClass "NSNumber"
    sendClassMsg cls' (mkSelector "numberWithUnsignedLong:") (retPtr retVoid) [argCULong value] >>= retainedObject . castPtr
...
numberWithLongLong value =
  do
    cls' <- getRequiredClass "NSNumber"
    sendClassMsg cls' (mkSelector "numberWithLongLong:") (retPtr retVoid) [argCLong value] >>= retainedObject . castPtr
...
numberWithUnsignedLongLong value =
  do
    cls' <- getRequiredClass "NSNumber"
    sendClassMsg cls' (mkSelector "numberWithUnsignedLongLong:") (retPtr retVoid) [argCULong value] >>= retainedObject . castPtr
...
numberWithFloat value =
  do
    cls' <- getRequiredClass "NSNumber"
    sendClassMsg cls' (mkSelector "numberWithFloat:") (retPtr retVoid) [argCFloat value] >>= retainedObject . castPtr
...
numberWithDouble value =
  do
    cls' <- getRequiredClass "NSNumber"
    sendClassMsg cls' (mkSelector "numberWithDouble:") (retPtr retVoid) [argCDouble value] >>= retainedObject . castPtr
...
numberWithInteger value =
  do
    cls' <- getRequiredClass "NSNumber"
    sendClassMsg cls' (mkSelector "numberWithInteger:") (retPtr retVoid) [argCLong value] >>= retainedObject . castPtr
...
numberWithUnsignedInteger value =
  do
    cls' <- getRequiredClass "NSNumber"
    sendClassMsg cls' (mkSelector "numberWithUnsignedInteger:") (retPtr retVoid) [argCULong value] >>= retainedObject . castPtr
