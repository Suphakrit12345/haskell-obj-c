...
initWithStartLine_startColumn_endLine_endColumn nsAttributedStringMarkdownSourcePosition  startLine startColumn endLine endColumn =
    sendMsg nsAttributedStringMarkdownSourcePosition (mkSelector "initWithStartLine:startColumn:endLine:endColumn:") (retPtr retVoid) [argCLong startLine, argCLong startColumn, argCLong endLine, argCLong endColumn] >>= ownedObject . castPtr
