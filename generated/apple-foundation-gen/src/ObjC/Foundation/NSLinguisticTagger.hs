...
initWithTagSchemes_options nsLinguisticTagger  tagSchemes opts =
  withObjCPtr tagSchemes $ \raw_tagSchemes ->
      sendMsg nsLinguisticTagger (mkSelector "initWithTagSchemes:options:") (retPtr retVoid) [argPtr (castPtr raw_tagSchemes :: Ptr ()), argCULong opts] >>= ownedObject . castPtr
...
orthographyAtIndex_effectiveRange nsLinguisticTagger  charIndex effectiveRange =
    sendMsg nsLinguisticTagger (mkSelector "orthographyAtIndex:effectiveRange:") (retPtr retVoid) [argCULong charIndex, argPtr effectiveRange] >>= retainedObject . castPtr
...
stringEditedInRange_changeInLength nsLinguisticTagger  newRange delta =
    sendMsg nsLinguisticTagger (mkSelector "stringEditedInRange:changeInLength:") retVoid [argNSRange newRange, argCLong delta]
...
tokenRangeAtIndex_unit nsLinguisticTagger  charIndex unit =
    sendMsgStret nsLinguisticTagger (mkSelector "tokenRangeAtIndex:unit:") retNSRange [argCULong charIndex, argCLong (coerce unit)]
...
tagAtIndex_unit_scheme_tokenRange nsLinguisticTagger  charIndex unit scheme tokenRange =
  withObjCPtr scheme $ \raw_scheme ->
      sendMsg nsLinguisticTagger (mkSelector "tagAtIndex:unit:scheme:tokenRange:") (retPtr retVoid) [argCULong charIndex, argCLong (coerce unit), argPtr (castPtr raw_scheme :: Ptr ()), argPtr tokenRange] >>= retainedObject . castPtr
...
tagAtIndex_scheme_tokenRange_sentenceRange nsLinguisticTagger  charIndex scheme tokenRange sentenceRange =
  withObjCPtr scheme $ \raw_scheme ->
      sendMsg nsLinguisticTagger (mkSelector "tagAtIndex:scheme:tokenRange:sentenceRange:") (retPtr retVoid) [argCULong charIndex, argPtr (castPtr raw_scheme :: Ptr ()), argPtr tokenRange, argPtr sentenceRange] >>= retainedObject . castPtr
...
tagForString_atIndex_unit_scheme_orthography_tokenRange string charIndex unit scheme orthography tokenRange =
  do
    ...
    withObjCPtr string $ \raw_string ->
      withObjCPtr scheme $ \raw_scheme ->
        withObjCPtr orthography $ \raw_orthography ->
          sendClassMsg cls' (mkSelector "tagForString:atIndex:unit:scheme:orthography:tokenRange:") (retPtr retVoid) [argPtr (castPtr raw_string :: Ptr ()), argCULong charIndex, argCLong (coerce unit), argPtr (castPtr raw_scheme :: Ptr ()), argPtr (castPtr raw_orthography :: Ptr ()), argPtr tokenRange] >>= retainedObject . castPtr
...
possibleTagsAtIndex_scheme_tokenRange_sentenceRange_scores nsLinguisticTagger  charIndex tagScheme tokenRange sentenceRange scores =
  withObjCPtr tagScheme $ \raw_tagScheme ->
    withObjCPtr scores $ \raw_scores ->
        sendMsg nsLinguisticTagger (mkSelector "possibleTagsAtIndex:scheme:tokenRange:sentenceRange:scores:") (retPtr retVoid) [argCULong charIndex, argPtr (castPtr raw_tagScheme :: Ptr ()), argPtr tokenRange, argPtr sentenceRange, argPtr (castPtr raw_scores :: Ptr ())] >>= retainedObject . castPtr
