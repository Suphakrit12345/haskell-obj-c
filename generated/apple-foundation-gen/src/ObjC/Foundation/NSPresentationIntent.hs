...
paragraphIntentWithIdentity_nestedInsideIntent identity parent =
  do
    ...
    withObjCPtr parent $ \raw_parent ->
      sendClassMsg cls' (mkSelector "paragraphIntentWithIdentity:nestedInsideIntent:") (retPtr retVoid) [argCLong identity, argPtr (castPtr raw_parent :: Ptr ())] >>= retainedObject . castPtr
...
headerIntentWithIdentity_level_nestedInsideIntent identity level parent =
  do
    cls' <- getRequiredClass "NSPresentationIntent"
    withObjCPtr parent $ \raw_parent ->
      sendClassMsg cls' (mkSelector "headerIntentWithIdentity:level:nestedInsideIntent:") (retPtr retVoid) [argCLong identity, argCLong level, argPtr (castPtr raw_parent :: Ptr ())] >>= retainedObject . castPtr
...
codeBlockIntentWithIdentity_languageHint_nestedInsideIntent identity languageHint parent =
  do
    ...
    withObjCPtr languageHint $ \raw_languageHint ->
      withObjCPtr parent $ \raw_parent ->
        sendClassMsg cls' (mkSelector "codeBlockIntentWithIdentity:languageHint:nestedInsideIntent:") (retPtr retVoid) [argCLong identity, argPtr (castPtr raw_languageHint :: Ptr ()), argPtr (castPtr raw_parent :: Ptr ())] >>= retainedObject . castPtr
...
thematicBreakIntentWithIdentity_nestedInsideIntent identity parent =
  do
    cls' <- getRequiredClass "NSPresentationIntent"
    withObjCPtr parent $ \raw_parent ->
      sendClassMsg cls' (mkSelector "thematicBreakIntentWithIdentity:nestedInsideIntent:") (retPtr retVoid) [argCLong identity, argPtr (castPtr raw_parent :: Ptr ())] >>= retainedObject . castPtr
...
orderedListIntentWithIdentity_nestedInsideIntent identity parent =
  do
    cls' <- getRequiredClass "NSPresentationIntent"
    withObjCPtr parent $ \raw_parent ->
      sendClassMsg cls' (mkSelector "orderedListIntentWithIdentity:nestedInsideIntent:") (retPtr retVoid) [argCLong identity, argPtr (castPtr raw_parent :: Ptr ())] >>= retainedObject . castPtr
...
unorderedListIntentWithIdentity_nestedInsideIntent identity parent =
  do
    cls' <- getRequiredClass "NSPresentationIntent"
    withObjCPtr parent $ \raw_parent ->
      sendClassMsg cls' (mkSelector "unorderedListIntentWithIdentity:nestedInsideIntent:") (retPtr retVoid) [argCLong identity, argPtr (castPtr raw_parent :: Ptr ())] >>= retainedObject . castPtr
...
listItemIntentWithIdentity_ordinal_nestedInsideIntent identity ordinal parent =
  do
    cls' <- getRequiredClass "NSPresentationIntent"
    withObjCPtr parent $ \raw_parent ->
      sendClassMsg cls' (mkSelector "listItemIntentWithIdentity:ordinal:nestedInsideIntent:") (retPtr retVoid) [argCLong identity, argCLong ordinal, argPtr (castPtr raw_parent :: Ptr ())] >>= retainedObject . castPtr
...
blockQuoteIntentWithIdentity_nestedInsideIntent identity parent =
  do
    cls' <- getRequiredClass "NSPresentationIntent"
    withObjCPtr parent $ \raw_parent ->
      sendClassMsg cls' (mkSelector "blockQuoteIntentWithIdentity:nestedInsideIntent:") (retPtr retVoid) [argCLong identity, argPtr (castPtr raw_parent :: Ptr ())] >>= retainedObject . castPtr
...
tableIntentWithIdentity_columnCount_alignments_nestedInsideIntent identity columnCount alignments parent =
  do
    ...
    withObjCPtr alignments $ \raw_alignments ->
      withObjCPtr parent $ \raw_parent ->
        sendClassMsg cls' (mkSelector "tableIntentWithIdentity:columnCount:alignments:nestedInsideIntent:") (retPtr retVoid) [argCLong identity, argCLong columnCount, argPtr (castPtr raw_alignments :: Ptr ()), argPtr (castPtr raw_parent :: Ptr ())] >>= retainedObject . castPtr
...
tableHeaderRowIntentWithIdentity_nestedInsideIntent identity parent =
  do
    cls' <- getRequiredClass "NSPresentationIntent"
    withObjCPtr parent $ \raw_parent ->
      sendClassMsg cls' (mkSelector "tableHeaderRowIntentWithIdentity:nestedInsideIntent:") (retPtr retVoid) [argCLong identity, argPtr (castPtr raw_parent :: Ptr ())] >>= retainedObject . castPtr
...
tableRowIntentWithIdentity_row_nestedInsideIntent identity row parent =
  do
    cls' <- getRequiredClass "NSPresentationIntent"
    withObjCPtr parent $ \raw_parent ->
      sendClassMsg cls' (mkSelector "tableRowIntentWithIdentity:row:nestedInsideIntent:") (retPtr retVoid) [argCLong identity, argCLong row, argPtr (castPtr raw_parent :: Ptr ())] >>= retainedObject . castPtr
...
tableCellIntentWithIdentity_column_nestedInsideIntent identity column parent =
  do
    cls' <- getRequiredClass "NSPresentationIntent"
    withObjCPtr parent $ \raw_parent ->
      sendClassMsg cls' (mkSelector "tableCellIntentWithIdentity:column:nestedInsideIntent:") (retPtr retVoid) [argCLong identity, argCLong column, argPtr (castPtr raw_parent :: Ptr ())] >>= retainedObject . castPtr
