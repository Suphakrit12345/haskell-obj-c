...
stringFromValue_unit nsLengthFormatter  value unit =
    sendMsg nsLengthFormatter (mkSelector "stringFromValue:unit:") (retPtr retVoid) [argCDouble value, argCLong (coerce unit)] >>= retainedObject . castPtr
...
stringFromMeters nsLengthFormatter  numberInMeters =
    sendMsg nsLengthFormatter (mkSelector "stringFromMeters:") (retPtr retVoid) [argCDouble numberInMeters] >>= retainedObject . castPtr
...
unitStringFromValue_unit nsLengthFormatter  value unit =
    sendMsg nsLengthFormatter (mkSelector "unitStringFromValue:unit:") (retPtr retVoid) [argCDouble value, argCLong (coerce unit)] >>= retainedObject . castPtr
...
unitStringFromMeters_usedUnit nsLengthFormatter  numberInMeters unitp =
    sendMsg nsLengthFormatter (mkSelector "unitStringFromMeters:usedUnit:") (retPtr retVoid) [argCDouble numberInMeters, argPtr unitp] >>= retainedObject . castPtr
