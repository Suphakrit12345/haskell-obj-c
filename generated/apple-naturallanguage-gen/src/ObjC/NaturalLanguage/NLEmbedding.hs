...
wordEmbeddingForLanguage_revision language revision =
  do
    cls' <- getRequiredClass "NLEmbedding"
    withObjCPtr language $ \raw_language ->
      sendClassMsg cls' (mkSelector "wordEmbeddingForLanguage:revision:") (retPtr retVoid) [argPtr (castPtr raw_language :: Ptr ()), argCULong revision] >>= retainedObject . castPtr
...
sentenceEmbeddingForLanguage_revision language revision =
  do
    cls' <- getRequiredClass "NLEmbedding"
    withObjCPtr language $ \raw_language ->
      sendClassMsg cls' (mkSelector "sentenceEmbeddingForLanguage:revision:") (retPtr retVoid) [argPtr (castPtr raw_language :: Ptr ()), argCULong revision] >>= retainedObject . castPtr
...
enumerateNeighborsForString_maximumCount_distanceType_usingBlock nlEmbedding  string maxCount distanceType block =
  withObjCPtr string $ \raw_string ->
      sendMsg nlEmbedding (mkSelector "enumerateNeighborsForString:maximumCount:distanceType:usingBlock:") retVoid [argPtr (castPtr raw_string :: Ptr ()), argCULong maxCount, argCLong (coerce distanceType), argPtr (castPtr block :: Ptr ())]
...
enumerateNeighborsForString_maximumCount_maximumDistance_distanceType_usingBlock nlEmbedding  string maxCount maxDistance distanceType block =
  withObjCPtr string $ \raw_string ->
      sendMsg nlEmbedding (mkSelector "enumerateNeighborsForString:maximumCount:maximumDistance:distanceType:usingBlock:") retVoid [argPtr (castPtr raw_string :: Ptr ()), argCULong maxCount, argCDouble maxDistance, argCLong (coerce distanceType), argPtr (castPtr block :: Ptr ())]
...
neighborsForString_maximumCount_distanceType nlEmbedding  string maxCount distanceType =
  withObjCPtr string $ \raw_string ->
      sendMsg nlEmbedding (mkSelector "neighborsForString:maximumCount:distanceType:") (retPtr retVoid) [argPtr (castPtr raw_string :: Ptr ()), argCULong maxCount, argCLong (coerce distanceType)] >>= retainedObject . castPtr
...
neighborsForString_maximumCount_maximumDistance_distanceType nlEmbedding  string maxCount maxDistance distanceType =
  withObjCPtr string $ \raw_string ->
      sendMsg nlEmbedding (mkSelector "neighborsForString:maximumCount:maximumDistance:distanceType:") (retPtr retVoid) [argPtr (castPtr raw_string :: Ptr ()), argCULong maxCount, argCDouble maxDistance, argCLong (coerce distanceType)] >>= retainedObject . castPtr
...
enumerateNeighborsForVector_maximumCount_distanceType_usingBlock nlEmbedding  vector maxCount distanceType block =
  withObjCPtr vector $ \raw_vector ->
      sendMsg nlEmbedding (mkSelector "enumerateNeighborsForVector:maximumCount:distanceType:usingBlock:") retVoid [argPtr (castPtr raw_vector :: Ptr ()), argCULong maxCount, argCLong (coerce distanceType), argPtr (castPtr block :: Ptr ())]
...
enumerateNeighborsForVector_maximumCount_maximumDistance_distanceType_usingBlock nlEmbedding  vector maxCount maxDistance distanceType block =
  withObjCPtr vector $ \raw_vector ->
      sendMsg nlEmbedding (mkSelector "enumerateNeighborsForVector:maximumCount:maximumDistance:distanceType:usingBlock:") retVoid [argPtr (castPtr raw_vector :: Ptr ()), argCULong maxCount, argCDouble maxDistance, argCLong (coerce distanceType), argPtr (castPtr block :: Ptr ())]
...
neighborsForVector_maximumCount_distanceType nlEmbedding  vector maxCount distanceType =
  withObjCPtr vector $ \raw_vector ->
      sendMsg nlEmbedding (mkSelector "neighborsForVector:maximumCount:distanceType:") (retPtr retVoid) [argPtr (castPtr raw_vector :: Ptr ()), argCULong maxCount, argCLong (coerce distanceType)] >>= retainedObject . castPtr
...
neighborsForVector_maximumCount_maximumDistance_distanceType nlEmbedding  vector maxCount maxDistance distanceType =
  withObjCPtr vector $ \raw_vector ->
      sendMsg nlEmbedding (mkSelector "neighborsForVector:maximumCount:maximumDistance:distanceType:") (retPtr retVoid) [argPtr (castPtr raw_vector :: Ptr ()), argCULong maxCount, argCDouble maxDistance, argCLong (coerce distanceType)] >>= retainedObject . castPtr
  ...
  do
    ...
    withObjCPtr dictionary $ \raw_dictionary ->
      withObjCPtr language $ \raw_language ->
        withObjCPtr url $ \raw_url ->
          withObjCPtr error_ $ \raw_error_ ->
            fmap ((/= 0) :: CULong -> Bool) $ sendClassMsg cls' (mkSelector "writeEmbeddingForDictionary:language:revision:toURL:error:") retCULong [argPtr (castPtr raw_dictionary :: Ptr ()), argPtr (castPtr raw_language :: Ptr ()), argCULong revision, argPtr (castPtr raw_url :: Ptr ()), argPtr (castPtr raw_error_ :: Ptr ())]
