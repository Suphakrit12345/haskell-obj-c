...
waitForEvent_value mpsGraphExecutableExecutionDescriptor  event value =
    sendMsg mpsGraphExecutableExecutionDescriptor (mkSelector "waitForEvent:value:") retVoid [argPtr (castPtr (unRawId event) :: Ptr ()), argCULong value]
...
signalEvent_atExecutionEvent_value mpsGraphExecutableExecutionDescriptor  event executionStage value =
    sendMsg mpsGraphExecutableExecutionDescriptor (mkSelector "signalEvent:atExecutionEvent:value:") retVoid [argPtr (castPtr (unRawId event) :: Ptr ()), argCULong (coerce executionStage), argCULong value]
