...
initDailyRecurrenceWithInterval_end calRecurrenceRule  interval end =
  withObjCPtr end $ \raw_end ->
      fmap (RawId . castPtr) $ sendMsg calRecurrenceRule (mkSelector "initDailyRecurrenceWithInterval:end:") (retPtr retVoid) [argCULong interval, argPtr (castPtr raw_end :: Ptr ())]
...
initWeeklyRecurrenceWithInterval_end calRecurrenceRule  interval end =
  withObjCPtr end $ \raw_end ->
      fmap (RawId . castPtr) $ sendMsg calRecurrenceRule (mkSelector "initWeeklyRecurrenceWithInterval:end:") (retPtr retVoid) [argCULong interval, argPtr (castPtr raw_end :: Ptr ())]
...
initWeeklyRecurrenceWithInterval_forDaysOfTheWeek_end calRecurrenceRule  interval days end =
  withObjCPtr days $ \raw_days ->
    withObjCPtr end $ \raw_end ->
        fmap (RawId . castPtr) $ sendMsg calRecurrenceRule (mkSelector "initWeeklyRecurrenceWithInterval:forDaysOfTheWeek:end:") (retPtr retVoid) [argCULong interval, argPtr (castPtr raw_days :: Ptr ()), argPtr (castPtr raw_end :: Ptr ())]
...
initMonthlyRecurrenceWithInterval_end calRecurrenceRule  interval end =
  withObjCPtr end $ \raw_end ->
      fmap (RawId . castPtr) $ sendMsg calRecurrenceRule (mkSelector "initMonthlyRecurrenceWithInterval:end:") (retPtr retVoid) [argCULong interval, argPtr (castPtr raw_end :: Ptr ())]
...
initMonthlyRecurrenceWithInterval_forDaysOfTheMonth_end calRecurrenceRule  interval monthDays end =
  withObjCPtr monthDays $ \raw_monthDays ->
    withObjCPtr end $ \raw_end ->
        fmap (RawId . castPtr) $ sendMsg calRecurrenceRule (mkSelector "initMonthlyRecurrenceWithInterval:forDaysOfTheMonth:end:") (retPtr retVoid) [argCULong interval, argPtr (castPtr raw_monthDays :: Ptr ()), argPtr (castPtr raw_end :: Ptr ())]
...
initMonthlyRecurrenceWithInterval_forDayOfTheWeek_forWeekOfTheMonth_end calRecurrenceRule  interval weekDay monthWeek end =
  withObjCPtr end $ \raw_end ->
      fmap (RawId . castPtr) $ sendMsg calRecurrenceRule (mkSelector "initMonthlyRecurrenceWithInterval:forDayOfTheWeek:forWeekOfTheMonth:end:") (retPtr retVoid) [argCULong interval, argCULong weekDay, argCLong monthWeek, argPtr (castPtr raw_end :: Ptr ())]
...
initYearlyRecurrenceWithInterval_end calRecurrenceRule  interval end =
  withObjCPtr end $ \raw_end ->
      fmap (RawId . castPtr) $ sendMsg calRecurrenceRule (mkSelector "initYearlyRecurrenceWithInterval:end:") (retPtr retVoid) [argCULong interval, argPtr (castPtr raw_end :: Ptr ())]
...
initYearlyRecurrenceWithInterval_forMonthsOfTheYear_end calRecurrenceRule  interval months end =
  withObjCPtr months $ \raw_months ->
    withObjCPtr end $ \raw_end ->
        fmap (RawId . castPtr) $ sendMsg calRecurrenceRule (mkSelector "initYearlyRecurrenceWithInterval:forMonthsOfTheYear:end:") (retPtr retVoid) [argCULong interval, argPtr (castPtr raw_months :: Ptr ()), argPtr (castPtr raw_end :: Ptr ())]
...
initYearlyRecurrenceWithInterval_forDayOfTheWeek_forWeekOfTheMonth_forMonthsOfTheYear_end calRecurrenceRule  interval weekDay monthWeek months end =
  withObjCPtr months $ \raw_months ->
    withObjCPtr end $ \raw_end ->
        fmap (RawId . castPtr) $ sendMsg calRecurrenceRule (mkSelector "initYearlyRecurrenceWithInterval:forDayOfTheWeek:forWeekOfTheMonth:forMonthsOfTheYear:end:") (retPtr retVoid) [argCULong interval, argCULong weekDay, argCLong monthWeek, argPtr (castPtr raw_months :: Ptr ()), argPtr (castPtr raw_end :: Ptr ())]
