...
stopWithBlendOutDuration scnAnimationPlayer  duration =
    sendMsg scnAnimationPlayer (mkSelector "stopWithBlendOutDuration:") retVoid [argCDouble duration]
...
setSpeed scnAnimationPlayer  value =
    sendMsg scnAnimationPlayer (mkSelector "setSpeed:") retVoid [argCDouble value]
...
setBlendFactor scnAnimationPlayer  value =
    sendMsg scnAnimationPlayer (mkSelector "setBlendFactor:") retVoid [argCDouble value]
