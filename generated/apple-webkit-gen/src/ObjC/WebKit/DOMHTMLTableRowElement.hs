...
insertCell domhtmlTableRowElement  index =
    sendMsg domhtmlTableRowElement (mkSelector "insertCell:") (retPtr retVoid) [argCInt index] >>= retainedObject . castPtr
...
deleteCell domhtmlTableRowElement  index =
    sendMsg domhtmlTableRowElement (mkSelector "deleteCell:") retVoid [argCInt index]
