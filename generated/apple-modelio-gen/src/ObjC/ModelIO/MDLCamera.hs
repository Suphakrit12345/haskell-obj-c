...
setNearVisibilityDistance mdlCamera  value =
    sendMsg mdlCamera (mkSelector "setNearVisibilityDistance:") retVoid [argCFloat value]
...
setFarVisibilityDistance mdlCamera  value =
    sendMsg mdlCamera (mkSelector "setFarVisibilityDistance:") retVoid [argCFloat value]
...
setWorldToMetersConversionScale mdlCamera  value =
    sendMsg mdlCamera (mkSelector "setWorldToMetersConversionScale:") retVoid [argCFloat value]
...
setBarrelDistortion mdlCamera  value =
    sendMsg mdlCamera (mkSelector "setBarrelDistortion:") retVoid [argCFloat value]
...
setFisheyeDistortion mdlCamera  value =
    sendMsg mdlCamera (mkSelector "setFisheyeDistortion:") retVoid [argCFloat value]
...
setOpticalVignetting mdlCamera  value =
    sendMsg mdlCamera (mkSelector "setOpticalVignetting:") retVoid [argCFloat value]
...
setChromaticAberration mdlCamera  value =
    sendMsg mdlCamera (mkSelector "setChromaticAberration:") retVoid [argCFloat value]
...
setFocalLength mdlCamera  value =
    sendMsg mdlCamera (mkSelector "setFocalLength:") retVoid [argCFloat value]
...
setFocusDistance mdlCamera  value =
    sendMsg mdlCamera (mkSelector "setFocusDistance:") retVoid [argCFloat value]
...
setFieldOfView mdlCamera  value =
    sendMsg mdlCamera (mkSelector "setFieldOfView:") retVoid [argCFloat value]
...
setFStop mdlCamera  value =
    sendMsg mdlCamera (mkSelector "setFStop:") retVoid [argCFloat value]
...
setApertureBladeCount mdlCamera  value =
    sendMsg mdlCamera (mkSelector "setApertureBladeCount:") retVoid [argCULong value]
...
setMaximumCircleOfConfusion mdlCamera  value =
    sendMsg mdlCamera (mkSelector "setMaximumCircleOfConfusion:") retVoid [argCFloat value]
...
setShutterOpenInterval mdlCamera  value =
    sendMsg mdlCamera (mkSelector "setShutterOpenInterval:") retVoid [argCDouble value]
...
setSensorVerticalAperture mdlCamera  value =
    sendMsg mdlCamera (mkSelector "setSensorVerticalAperture:") retVoid [argCFloat value]
...
setSensorAspect mdlCamera  value =
    sendMsg mdlCamera (mkSelector "setSensorAspect:") retVoid [argCFloat value]
