...
provideImageData_bytesPerRow_origin__size__userInfo nsObject  data_ rowbytes originx originy width height info =
    sendMsg nsObject (mkSelector "provideImageData:bytesPerRow:origin::size::userInfo:") retVoid [argPtr data_, argCULong rowbytes, argCULong originx, argCULong originy, argCULong width, argCULong height, argPtr (castPtr (unRawId info) :: Ptr ())]
...
provideImageToMTLTexture_commandBuffer_originx_originy_width_height_userInfo nsObject  texture commandBuffer originx originy width height info =
    sendMsg nsObject (mkSelector "provideImageToMTLTexture:commandBuffer:originx:originy:width:height:userInfo:") retVoid [argPtr (castPtr (unRawId texture) :: Ptr ()), argPtr (castPtr (unRawId commandBuffer) :: Ptr ()), argCULong originx, argCULong originy, argCULong width, argCULong height, argPtr (castPtr (unRawId info) :: Ptr ())]
