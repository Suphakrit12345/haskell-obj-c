...
setMaxCount nsRelationshipDescription  value =
    sendMsg nsRelationshipDescription (mkSelector "setMaxCount:") retVoid [argCULong value]
...
setMinCount nsRelationshipDescription  value =
    sendMsg nsRelationshipDescription (mkSelector "setMinCount:") retVoid [argCULong value]
