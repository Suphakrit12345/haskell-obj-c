...
managedObjectIDFromUTF8String_length nsPersistentStoreCoordinator  utf8string len =
    sendMsg nsPersistentStoreCoordinator (mkSelector "managedObjectIDFromUTF8String:length:") (retPtr retVoid) [argPtr (unConst utf8string), argCULong len] >>= retainedObject . castPtr
