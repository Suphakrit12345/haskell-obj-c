...
initWithObjectID_withValues_version nsIncrementalStoreNode  objectID values version =
  withObjCPtr objectID $ \raw_objectID ->
    withObjCPtr values $ \raw_values ->
        sendMsg nsIncrementalStoreNode (mkSelector "initWithObjectID:withValues:version:") (retPtr retVoid) [argPtr (castPtr raw_objectID :: Ptr ()), argPtr (castPtr raw_values :: Ptr ()), argCULong version] >>= ownedObject . castPtr
...
updateWithValues_version nsIncrementalStoreNode  values version =
  withObjCPtr values $ \raw_values ->
      sendMsg nsIncrementalStoreNode (mkSelector "updateWithValues:version:") retVoid [argPtr (castPtr raw_values :: Ptr ()), argCULong version]
