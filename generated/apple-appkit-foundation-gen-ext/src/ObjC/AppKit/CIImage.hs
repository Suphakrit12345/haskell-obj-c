...
drawInRect_fromRect_operation_fraction ciImage  rect fromRect op delta =
    sendMsg ciImage (mkSelector "drawInRect:fromRect:operation:fraction:") retVoid [argNSRect rect, argNSRect fromRect, argCULong (coerce op), argCDouble delta]
...
drawAtPoint_fromRect_operation_fraction ciImage  point fromRect op delta =
    sendMsg ciImage (mkSelector "drawAtPoint:fromRect:operation:fraction:") retVoid [argNSPoint point, argNSRect fromRect, argCULong (coerce op), argCDouble delta]
