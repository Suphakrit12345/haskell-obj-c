...
graphWithObstacles_bufferRadius obstacles bufferRadius =
  do
    ...
    withObjCPtr obstacles $ \raw_obstacles ->
      sendClassMsg cls' (mkSelector "graphWithObstacles:bufferRadius:") (retPtr retVoid) [argPtr (castPtr raw_obstacles :: Ptr ()), argCFloat bufferRadius] >>= retainedObject . castPtr
...
initWithObstacles_bufferRadius gkObstacleGraph  obstacles bufferRadius =
  withObjCPtr obstacles $ \raw_obstacles ->
      sendMsg gkObstacleGraph (mkSelector "initWithObstacles:bufferRadius:") (retPtr retVoid) [argPtr (castPtr raw_obstacles :: Ptr ()), argCFloat bufferRadius] >>= ownedObject . castPtr
...
graphWithObstacles_bufferRadius_nodeClass obstacles bufferRadius nodeClass =
  do
    cls' <- getRequiredClass "GKObstacleGraph"
    withObjCPtr obstacles $ \raw_obstacles ->
      sendClassMsg cls' (mkSelector "graphWithObstacles:bufferRadius:nodeClass:") (retPtr retVoid) [argPtr (castPtr raw_obstacles :: Ptr ()), argCFloat bufferRadius, argPtr (unClass nodeClass)] >>= retainedObject . castPtr
...
initWithObstacles_bufferRadius_nodeClass gkObstacleGraph  obstacles bufferRadius nodeClass =
  withObjCPtr obstacles $ \raw_obstacles ->
      sendMsg gkObstacleGraph (mkSelector "initWithObstacles:bufferRadius:nodeClass:") (retPtr retVoid) [argPtr (castPtr raw_obstacles :: Ptr ()), argCFloat bufferRadius, argPtr (unClass nodeClass)] >>= ownedObject . castPtr
...
classForGenericArgumentAtIndex gkObstacleGraph  index =
    fmap (Class . castPtr) $ sendMsg gkObstacleGraph (mkSelector "classForGenericArgumentAtIndex:") (retPtr retVoid) [argCULong index]
