...
perlinNoiseSourceWithFrequency_octaveCount_persistence_lacunarity_seed frequency octaveCount persistence lacunarity seed =
  do
    ...
    sendClassMsg cls' (mkSelector "perlinNoiseSourceWithFrequency:octaveCount:persistence:lacunarity:seed:") (retPtr retVoid) [argCDouble frequency, argCLong octaveCount, argCDouble persistence, argCDouble lacunarity, argCInt seed] >>= retainedObject . castPtr
...
initWithFrequency_octaveCount_persistence_lacunarity_seed gkPerlinNoiseSource  frequency octaveCount persistence lacunarity seed =
    sendMsg gkPerlinNoiseSource (mkSelector "initWithFrequency:octaveCount:persistence:lacunarity:seed:") (retPtr retVoid) [argCDouble frequency, argCLong octaveCount, argCDouble persistence, argCDouble lacunarity, argCInt seed] >>= ownedObject . castPtr
...
setPersistence gkPerlinNoiseSource  value =
    sendMsg gkPerlinNoiseSource (mkSelector "setPersistence:") retVoid [argCDouble value]
