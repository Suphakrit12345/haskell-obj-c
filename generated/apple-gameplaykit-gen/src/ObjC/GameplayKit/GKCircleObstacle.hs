...
initWithRadius gkCircleObstacle  radius =
    sendMsg gkCircleObstacle (mkSelector "initWithRadius:") (retPtr retVoid) [argCFloat radius] >>= ownedObject . castPtr
...
setRadius gkCircleObstacle  value =
    sendMsg gkCircleObstacle (mkSelector "setRadius:") retVoid [argCFloat value]
