...
initWithSeed gkMersenneTwisterRandomSource  seed =
    sendMsg gkMersenneTwisterRandomSource (mkSelector "initWithSeed:") (retPtr retVoid) [argCULong seed] >>= ownedObject . castPtr
...
setSeed gkMersenneTwisterRandomSource  value =
    sendMsg gkMersenneTwisterRandomSource (mkSelector "setSeed:") retVoid [argCULong value]
