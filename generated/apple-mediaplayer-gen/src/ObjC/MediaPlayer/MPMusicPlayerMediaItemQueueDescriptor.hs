...
setStartTime_forItem mpMusicPlayerMediaItemQueueDescriptor  startTime mediaItem =
  withObjCPtr mediaItem $ \raw_mediaItem ->
      sendMsg mpMusicPlayerMediaItemQueueDescriptor (mkSelector "setStartTime:forItem:") retVoid [argCDouble startTime, argPtr (castPtr raw_mediaItem :: Ptr ())]
...
setEndTime_forItem mpMusicPlayerMediaItemQueueDescriptor  endTime mediaItem =
  withObjCPtr mediaItem $ \raw_mediaItem ->
      sendMsg mpMusicPlayerMediaItemQueueDescriptor (mkSelector "setEndTime:forItem:") retVoid [argCDouble endTime, argPtr (castPtr raw_mediaItem :: Ptr ())]
