...
objectAtIndexedSubscript mtlVertexAttributeDescriptorArray  index =
    sendMsg mtlVertexAttributeDescriptorArray (mkSelector "objectAtIndexedSubscript:") (retPtr retVoid) [argCULong index] >>= retainedObject . castPtr
...
setObject_atIndexedSubscript mtlVertexAttributeDescriptorArray  attributeDesc index =
  withObjCPtr attributeDesc $ \raw_attributeDesc ->
      sendMsg mtlVertexAttributeDescriptorArray (mkSelector "setObject:atIndexedSubscript:") retVoid [argPtr (castPtr raw_attributeDesc :: Ptr ()), argCULong index]
