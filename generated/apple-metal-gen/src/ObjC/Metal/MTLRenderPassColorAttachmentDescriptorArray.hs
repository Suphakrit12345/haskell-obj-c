...
objectAtIndexedSubscript mtlRenderPassColorAttachmentDescriptorArray  attachmentIndex =
    sendMsg mtlRenderPassColorAttachmentDescriptorArray (mkSelector "objectAtIndexedSubscript:") (retPtr retVoid) [argCULong attachmentIndex] >>= retainedObject . castPtr
...
setObject_atIndexedSubscript mtlRenderPassColorAttachmentDescriptorArray  attachment attachmentIndex =
  withObjCPtr attachment $ \raw_attachment ->
      sendMsg mtlRenderPassColorAttachmentDescriptorArray (mkSelector "setObject:atIndexedSubscript:") retVoid [argPtr (castPtr raw_attachment :: Ptr ()), argCULong attachmentIndex]
