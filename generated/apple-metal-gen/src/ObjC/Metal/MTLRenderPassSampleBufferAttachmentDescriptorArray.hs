...
objectAtIndexedSubscript mtlRenderPassSampleBufferAttachmentDescriptorArray  attachmentIndex =
    sendMsg mtlRenderPassSampleBufferAttachmentDescriptorArray (mkSelector "objectAtIndexedSubscript:") (retPtr retVoid) [argCULong attachmentIndex] >>= retainedObject . castPtr
...
setObject_atIndexedSubscript mtlRenderPassSampleBufferAttachmentDescriptorArray  attachment attachmentIndex =
  withObjCPtr attachment $ \raw_attachment ->
      sendMsg mtlRenderPassSampleBufferAttachmentDescriptorArray (mkSelector "setObject:atIndexedSubscript:") retVoid [argPtr (castPtr raw_attachment :: Ptr ()), argCULong attachmentIndex]
