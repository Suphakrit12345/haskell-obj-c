...
setMotionStartTime mtlPrimitiveAccelerationStructureDescriptor  value =
    sendMsg mtlPrimitiveAccelerationStructureDescriptor (mkSelector "setMotionStartTime:") retVoid [argCFloat value]
...
setMotionEndTime mtlPrimitiveAccelerationStructureDescriptor  value =
    sendMsg mtlPrimitiveAccelerationStructureDescriptor (mkSelector "setMotionEndTime:") retVoid [argCFloat value]
...
setMotionKeyframeCount mtlPrimitiveAccelerationStructureDescriptor  value =
    sendMsg mtlPrimitiveAccelerationStructureDescriptor (mkSelector "setMotionKeyframeCount:") retVoid [argCULong value]
