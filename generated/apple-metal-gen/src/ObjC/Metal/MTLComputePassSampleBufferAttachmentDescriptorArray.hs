...
objectAtIndexedSubscript mtlComputePassSampleBufferAttachmentDescriptorArray  attachmentIndex =
    sendMsg mtlComputePassSampleBufferAttachmentDescriptorArray (mkSelector "objectAtIndexedSubscript:") (retPtr retVoid) [argCULong attachmentIndex] >>= retainedObject . castPtr
...
setObject_atIndexedSubscript mtlComputePassSampleBufferAttachmentDescriptorArray  attachment attachmentIndex =
  withObjCPtr attachment $ \raw_attachment ->
      sendMsg mtlComputePassSampleBufferAttachmentDescriptorArray (mkSelector "setObject:atIndexedSubscript:") retVoid [argPtr (castPtr raw_attachment :: Ptr ()), argCULong attachmentIndex]
