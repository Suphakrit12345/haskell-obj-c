...
objectAtIndexedSubscript mtlRenderPipelineColorAttachmentDescriptorArray  attachmentIndex =
    sendMsg mtlRenderPipelineColorAttachmentDescriptorArray (mkSelector "objectAtIndexedSubscript:") (retPtr retVoid) [argCULong attachmentIndex] >>= retainedObject . castPtr
...
setObject_atIndexedSubscript mtlRenderPipelineColorAttachmentDescriptorArray  attachment attachmentIndex =
  withObjCPtr attachment $ \raw_attachment ->
      sendMsg mtlRenderPipelineColorAttachmentDescriptorArray (mkSelector "setObject:atIndexedSubscript:") retVoid [argPtr (castPtr raw_attachment :: Ptr ()), argCULong attachmentIndex]
