...
objectAtIndexedSubscript mtlRasterizationRateSampleArray  index =
    sendMsg mtlRasterizationRateSampleArray (mkSelector "objectAtIndexedSubscript:") (retPtr retVoid) [argCULong index] >>= retainedObject . castPtr
...
setObject_atIndexedSubscript mtlRasterizationRateSampleArray  value index =
  withObjCPtr value $ \raw_value ->
      sendMsg mtlRasterizationRateSampleArray (mkSelector "setObject:atIndexedSubscript:") retVoid [argPtr (castPtr raw_value :: Ptr ()), argCULong index]
