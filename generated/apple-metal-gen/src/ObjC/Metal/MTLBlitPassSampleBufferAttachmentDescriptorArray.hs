...
objectAtIndexedSubscript mtlBlitPassSampleBufferAttachmentDescriptorArray  attachmentIndex =
    sendMsg mtlBlitPassSampleBufferAttachmentDescriptorArray (mkSelector "objectAtIndexedSubscript:") (retPtr retVoid) [argCULong attachmentIndex] >>= retainedObject . castPtr
...
setObject_atIndexedSubscript mtlBlitPassSampleBufferAttachmentDescriptorArray  attachment attachmentIndex =
  withObjCPtr attachment $ \raw_attachment ->
      sendMsg mtlBlitPassSampleBufferAttachmentDescriptorArray (mkSelector "setObject:atIndexedSubscript:") retVoid [argPtr (castPtr raw_attachment :: Ptr ()), argCULong attachmentIndex]
