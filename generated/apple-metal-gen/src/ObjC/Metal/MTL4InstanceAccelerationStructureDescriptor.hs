...
setInstanceDescriptorStride mtL4InstanceAccelerationStructureDescriptor  value =
    sendMsg mtL4InstanceAccelerationStructureDescriptor (mkSelector "setInstanceDescriptorStride:") retVoid [argCULong value]
...
setInstanceCount mtL4InstanceAccelerationStructureDescriptor  value =
    sendMsg mtL4InstanceAccelerationStructureDescriptor (mkSelector "setInstanceCount:") retVoid [argCULong value]
...
setMotionTransformCount mtL4InstanceAccelerationStructureDescriptor  value =
    sendMsg mtL4InstanceAccelerationStructureDescriptor (mkSelector "setMotionTransformCount:") retVoid [argCULong value]
...
setMotionTransformStride mtL4InstanceAccelerationStructureDescriptor  value =
    sendMsg mtL4InstanceAccelerationStructureDescriptor (mkSelector "setMotionTransformStride:") retVoid [argCULong value]
