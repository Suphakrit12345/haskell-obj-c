...
objectAtIndexedSubscript mtlBufferLayoutDescriptorArray  index =
    sendMsg mtlBufferLayoutDescriptorArray (mkSelector "objectAtIndexedSubscript:") (retPtr retVoid) [argCULong index] >>= retainedObject . castPtr
...
setObject_atIndexedSubscript mtlBufferLayoutDescriptorArray  bufferDesc index =
  withObjCPtr bufferDesc $ \raw_bufferDesc ->
      sendMsg mtlBufferLayoutDescriptorArray (mkSelector "setObject:atIndexedSubscript:") retVoid [argPtr (castPtr raw_bufferDesc :: Ptr ()), argCULong index]
