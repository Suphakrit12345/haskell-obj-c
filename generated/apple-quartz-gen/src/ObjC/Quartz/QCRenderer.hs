...
renderAtTime_arguments qcRenderer  time arguments =
  withObjCPtr arguments $ \raw_arguments ->
      fmap ((/= 0) :: CULong -> Bool) $ sendMsg qcRenderer (mkSelector "renderAtTime:arguments:") retCULong [argCDouble time, argPtr (castPtr raw_arguments :: Ptr ())]
...
renderingTimeForTime_arguments qcRenderer  time arguments =
  withObjCPtr arguments $ \raw_arguments ->
      sendMsg qcRenderer (mkSelector "renderingTimeForTime:arguments:") retCDouble [argCDouble time, argPtr (castPtr raw_arguments :: Ptr ())]
