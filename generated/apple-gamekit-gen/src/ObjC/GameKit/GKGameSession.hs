  ...
  do
    ...
    withObjCPtr containerName $ \raw_containerName ->
      withObjCPtr title $ \raw_title ->
        sendClassMsg cls' (mkSelector "createSessionInContainer:withTitle:maxConnectedPlayers:completionHandler:") retVoid [argPtr (castPtr raw_containerName :: Ptr ()), argPtr (castPtr raw_title :: Ptr ()), argCLong maxPlayers, argPtr (castPtr completionHandler :: Ptr ())]
