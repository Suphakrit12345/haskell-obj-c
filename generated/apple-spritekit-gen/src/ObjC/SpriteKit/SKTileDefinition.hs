...
setTimePerFrame skTileDefinition  value =
    sendMsg skTileDefinition (mkSelector "setTimePerFrame:") retVoid [argCDouble value]
...
setPlacementWeight skTileDefinition  value =
    sendMsg skTileDefinition (mkSelector "setPlacementWeight:") retVoid [argCULong value]
