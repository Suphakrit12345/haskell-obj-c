...
crossFadeWithDuration sec =
  do
    ...
    sendClassMsg cls' (mkSelector "crossFadeWithDuration:") (retPtr retVoid) [argCDouble sec] >>= retainedObject . castPtr
...
fadeWithDuration sec =
  do
    cls' <- getRequiredClass "SKTransition"
    sendClassMsg cls' (mkSelector "fadeWithDuration:") (retPtr retVoid) [argCDouble sec] >>= retainedObject . castPtr
...
fadeWithColor_duration color sec =
  do
    ...
    withObjCPtr color $ \raw_color ->
      sendClassMsg cls' (mkSelector "fadeWithColor:duration:") (retPtr retVoid) [argPtr (castPtr raw_color :: Ptr ()), argCDouble sec] >>= retainedObject . castPtr
...
flipHorizontalWithDuration sec =
  do
    cls' <- getRequiredClass "SKTransition"
    sendClassMsg cls' (mkSelector "flipHorizontalWithDuration:") (retPtr retVoid) [argCDouble sec] >>= retainedObject . castPtr
...
flipVerticalWithDuration sec =
  do
    cls' <- getRequiredClass "SKTransition"
    sendClassMsg cls' (mkSelector "flipVerticalWithDuration:") (retPtr retVoid) [argCDouble sec] >>= retainedObject . castPtr
...
revealWithDirection_duration direction sec =
  do
    cls' <- getRequiredClass "SKTransition"
    sendClassMsg cls' (mkSelector "revealWithDirection:duration:") (retPtr retVoid) [argCLong (coerce direction), argCDouble sec] >>= retainedObject . castPtr
...
moveInWithDirection_duration direction sec =
  do
    cls' <- getRequiredClass "SKTransition"
    sendClassMsg cls' (mkSelector "moveInWithDirection:duration:") (retPtr retVoid) [argCLong (coerce direction), argCDouble sec] >>= retainedObject . castPtr
...
pushWithDirection_duration direction sec =
  do
    cls' <- getRequiredClass "SKTransition"
    sendClassMsg cls' (mkSelector "pushWithDirection:duration:") (retPtr retVoid) [argCLong (coerce direction), argCDouble sec] >>= retainedObject . castPtr
...
doorsOpenHorizontalWithDuration sec =
  do
    cls' <- getRequiredClass "SKTransition"
    sendClassMsg cls' (mkSelector "doorsOpenHorizontalWithDuration:") (retPtr retVoid) [argCDouble sec] >>= retainedObject . castPtr
...
doorsOpenVerticalWithDuration sec =
  do
    cls' <- getRequiredClass "SKTransition"
    sendClassMsg cls' (mkSelector "doorsOpenVerticalWithDuration:") (retPtr retVoid) [argCDouble sec] >>= retainedObject . castPtr
...
doorsCloseHorizontalWithDuration sec =
  do
    cls' <- getRequiredClass "SKTransition"
    sendClassMsg cls' (mkSelector "doorsCloseHorizontalWithDuration:") (retPtr retVoid) [argCDouble sec] >>= retainedObject . castPtr
...
doorsCloseVerticalWithDuration sec =
  do
    cls' <- getRequiredClass "SKTransition"
    sendClassMsg cls' (mkSelector "doorsCloseVerticalWithDuration:") (retPtr retVoid) [argCDouble sec] >>= retainedObject . castPtr
...
doorwayWithDuration sec =
  do
    cls' <- getRequiredClass "SKTransition"
    sendClassMsg cls' (mkSelector "doorwayWithDuration:") (retPtr retVoid) [argCDouble sec] >>= retainedObject . castPtr
...
transitionWithCIFilter_duration filter_ sec =
  do
    ...
    withObjCPtr filter_ $ \raw_filter_ ->
      sendClassMsg cls' (mkSelector "transitionWithCIFilter:duration:") (retPtr retVoid) [argPtr (castPtr raw_filter_ :: Ptr ()), argCDouble sec] >>= retainedObject . castPtr
