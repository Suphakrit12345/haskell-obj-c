...
initWithCapacity skKeyframeSequence  numItems =
    sendMsg skKeyframeSequence (mkSelector "initWithCapacity:") (retPtr retVoid) [argCULong numItems] >>= ownedObject . castPtr
...
addKeyframeValue_time skKeyframeSequence  value time =
    sendMsg skKeyframeSequence (mkSelector "addKeyframeValue:time:") retVoid [argPtr (castPtr (unRawId value) :: Ptr ()), argCDouble time]
...
removeKeyframeAtIndex skKeyframeSequence  index =
    sendMsg skKeyframeSequence (mkSelector "removeKeyframeAtIndex:") retVoid [argCULong index]
...
setKeyframeValue_forIndex skKeyframeSequence  value index =
    sendMsg skKeyframeSequence (mkSelector "setKeyframeValue:forIndex:") retVoid [argPtr (castPtr (unRawId value) :: Ptr ()), argCULong index]
...
setKeyframeTime_forIndex skKeyframeSequence  time index =
    sendMsg skKeyframeSequence (mkSelector "setKeyframeTime:forIndex:") retVoid [argCDouble time, argCULong index]
...
setKeyframeValue_time_forIndex skKeyframeSequence  value time index =
    sendMsg skKeyframeSequence (mkSelector "setKeyframeValue:time:forIndex:") retVoid [argPtr (castPtr (unRawId value) :: Ptr ()), argCDouble time, argCULong index]
...
getKeyframeValueForIndex skKeyframeSequence  index =
    fmap (RawId . castPtr) $ sendMsg skKeyframeSequence (mkSelector "getKeyframeValueForIndex:") (retPtr retVoid) [argCULong index]
...
getKeyframeTimeForIndex skKeyframeSequence  index =
    sendMsg skKeyframeSequence (mkSelector "getKeyframeTimeForIndex:") retCDouble [argCULong index]
...
sampleAtTime skKeyframeSequence  time =
    fmap (RawId . castPtr) $ sendMsg skKeyframeSequence (mkSelector "sampleAtTime:") (retPtr retVoid) [argCDouble time]
