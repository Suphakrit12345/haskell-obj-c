...
initWithResponseValue_error mtrrvcOperationalStateClusterOperationalCommandResponseParams  responseValue error_ =
  withObjCPtr responseValue $ \raw_responseValue ->
    withObjCPtr error_ $ \raw_error_ ->
        sendMsg mtrrvcOperationalStateClusterOperationalCommandResponseParams (mkSelector "initWithResponseValue:error:") (retPtr retVoid) [argPtr (castPtr raw_responseValue :: Ptr ()), argPtr (castPtr raw_error_ :: Ptr ())] >>= ownedObject . castPtr
...
commandResponseState mtrrvcOperationalStateClusterOperationalCommandResponseParams  =
    sendMsg mtrrvcOperationalStateClusterOperationalCommandResponseParams (mkSelector "commandResponseState") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setCommandResponseState mtrrvcOperationalStateClusterOperationalCommandResponseParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrrvcOperationalStateClusterOperationalCommandResponseParams (mkSelector "setCommandResponseState:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
