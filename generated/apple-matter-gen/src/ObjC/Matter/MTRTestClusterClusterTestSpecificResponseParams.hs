...
returnValue mtrTestClusterClusterTestSpecificResponseParams  =
    sendMsg mtrTestClusterClusterTestSpecificResponseParams (mkSelector "returnValue") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setReturnValue mtrTestClusterClusterTestSpecificResponseParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrTestClusterClusterTestSpecificResponseParams (mkSelector "setReturnValue:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
...
timedInvokeTimeoutMs mtrTestClusterClusterTestSpecificResponseParams  =
    sendMsg mtrTestClusterClusterTestSpecificResponseParams (mkSelector "timedInvokeTimeoutMs") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setTimedInvokeTimeoutMs mtrTestClusterClusterTestSpecificResponseParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrTestClusterClusterTestSpecificResponseParams (mkSelector "setTimedInvokeTimeoutMs:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
