...
timedInvokeTimeoutMs mtrWiFiNetworkDiagnosticsClusterResetCountsParams  =
    sendMsg mtrWiFiNetworkDiagnosticsClusterResetCountsParams (mkSelector "timedInvokeTimeoutMs") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setTimedInvokeTimeoutMs mtrWiFiNetworkDiagnosticsClusterResetCountsParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrWiFiNetworkDiagnosticsClusterResetCountsParams (mkSelector "setTimedInvokeTimeoutMs:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
...
serverSideProcessingTimeout mtrWiFiNetworkDiagnosticsClusterResetCountsParams  =
    sendMsg mtrWiFiNetworkDiagnosticsClusterResetCountsParams (mkSelector "serverSideProcessingTimeout") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setServerSideProcessingTimeout mtrWiFiNetworkDiagnosticsClusterResetCountsParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrWiFiNetworkDiagnosticsClusterResetCountsParams (mkSelector "setServerSideProcessingTimeout:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
