...
snapshotStreamID mtrCameraAVStreamManagementClusterSnapshotStreamDeallocateParams  =
    sendMsg mtrCameraAVStreamManagementClusterSnapshotStreamDeallocateParams (mkSelector "snapshotStreamID") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setSnapshotStreamID mtrCameraAVStreamManagementClusterSnapshotStreamDeallocateParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrCameraAVStreamManagementClusterSnapshotStreamDeallocateParams (mkSelector "setSnapshotStreamID:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
...
timedInvokeTimeoutMs mtrCameraAVStreamManagementClusterSnapshotStreamDeallocateParams  =
    sendMsg mtrCameraAVStreamManagementClusterSnapshotStreamDeallocateParams (mkSelector "timedInvokeTimeoutMs") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setTimedInvokeTimeoutMs mtrCameraAVStreamManagementClusterSnapshotStreamDeallocateParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrCameraAVStreamManagementClusterSnapshotStreamDeallocateParams (mkSelector "setTimedInvokeTimeoutMs:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
...
serverSideProcessingTimeout mtrCameraAVStreamManagementClusterSnapshotStreamDeallocateParams  =
    sendMsg mtrCameraAVStreamManagementClusterSnapshotStreamDeallocateParams (mkSelector "serverSideProcessingTimeout") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setServerSideProcessingTimeout mtrCameraAVStreamManagementClusterSnapshotStreamDeallocateParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrCameraAVStreamManagementClusterSnapshotStreamDeallocateParams (mkSelector "setServerSideProcessingTimeout:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
