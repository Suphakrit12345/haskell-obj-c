  ...
  withObjCPtr params $ \raw_params ->
    withObjCPtr expectedDataValueDictionaries $ \raw_expectedDataValueDictionaries ->
      withObjCPtr expectedValueIntervalMs $ \raw_expectedValueIntervalMs ->
          sendMsg mtrClusterEnergyEVSEMode (mkSelector "changeToModeWithParams:expectedValues:expectedValueInterval:completion:") retVoid [argPtr (castPtr raw_params :: Ptr ()), argPtr (castPtr raw_expectedDataValueDictionaries :: Ptr ()), argPtr (castPtr raw_expectedValueIntervalMs :: Ptr ()), argPtr (castPtr completion :: Ptr ())]
...
readAttributeSupportedModesWithParams mtrClusterEnergyEVSEMode  params =
  withObjCPtr params $ \raw_params ->
      sendMsg mtrClusterEnergyEVSEMode (mkSelector "readAttributeSupportedModesWithParams:") (retPtr retVoid) [argPtr (castPtr raw_params :: Ptr ())] >>= retainedObject . castPtr
...
readAttributeCurrentModeWithParams mtrClusterEnergyEVSEMode  params =
  withObjCPtr params $ \raw_params ->
      sendMsg mtrClusterEnergyEVSEMode (mkSelector "readAttributeCurrentModeWithParams:") (retPtr retVoid) [argPtr (castPtr raw_params :: Ptr ())] >>= retainedObject . castPtr
...
readAttributeGeneratedCommandListWithParams mtrClusterEnergyEVSEMode  params =
  withObjCPtr params $ \raw_params ->
      sendMsg mtrClusterEnergyEVSEMode (mkSelector "readAttributeGeneratedCommandListWithParams:") (retPtr retVoid) [argPtr (castPtr raw_params :: Ptr ())] >>= retainedObject . castPtr
...
readAttributeAcceptedCommandListWithParams mtrClusterEnergyEVSEMode  params =
  withObjCPtr params $ \raw_params ->
      sendMsg mtrClusterEnergyEVSEMode (mkSelector "readAttributeAcceptedCommandListWithParams:") (retPtr retVoid) [argPtr (castPtr raw_params :: Ptr ())] >>= retainedObject . castPtr
...
readAttributeAttributeListWithParams mtrClusterEnergyEVSEMode  params =
  withObjCPtr params $ \raw_params ->
      sendMsg mtrClusterEnergyEVSEMode (mkSelector "readAttributeAttributeListWithParams:") (retPtr retVoid) [argPtr (castPtr raw_params :: Ptr ())] >>= retainedObject . castPtr
...
readAttributeFeatureMapWithParams mtrClusterEnergyEVSEMode  params =
  withObjCPtr params $ \raw_params ->
      sendMsg mtrClusterEnergyEVSEMode (mkSelector "readAttributeFeatureMapWithParams:") (retPtr retVoid) [argPtr (castPtr raw_params :: Ptr ())] >>= retainedObject . castPtr
...
readAttributeClusterRevisionWithParams mtrClusterEnergyEVSEMode  params =
  withObjCPtr params $ \raw_params ->
      sendMsg mtrClusterEnergyEVSEMode (mkSelector "readAttributeClusterRevisionWithParams:") (retPtr retVoid) [argPtr (castPtr raw_params :: Ptr ())] >>= retainedObject . castPtr
...
init_ mtrClusterEnergyEVSEMode  =
    sendMsg mtrClusterEnergyEVSEMode (mkSelector "init") (retPtr retVoid) [] >>= ownedObject . castPtr
  ...
  withObjCPtr device $ \raw_device ->
    withObjCPtr endpointID $ \raw_endpointID ->
      withObjCPtr queue $ \raw_queue ->
          sendMsg mtrClusterEnergyEVSEMode (mkSelector "initWithDevice:endpointID:queue:") (retPtr retVoid) [argPtr (castPtr raw_device :: Ptr ()), argPtr (castPtr raw_endpointID :: Ptr ()), argPtr (castPtr raw_queue :: Ptr ())] >>= ownedObject . castPtr
