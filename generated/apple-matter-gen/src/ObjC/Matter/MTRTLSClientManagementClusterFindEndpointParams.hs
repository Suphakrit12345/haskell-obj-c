...
endpointID mtrtlsClientManagementClusterFindEndpointParams  =
    sendMsg mtrtlsClientManagementClusterFindEndpointParams (mkSelector "endpointID") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setEndpointID mtrtlsClientManagementClusterFindEndpointParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrtlsClientManagementClusterFindEndpointParams (mkSelector "setEndpointID:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
...
timedInvokeTimeoutMs mtrtlsClientManagementClusterFindEndpointParams  =
    sendMsg mtrtlsClientManagementClusterFindEndpointParams (mkSelector "timedInvokeTimeoutMs") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setTimedInvokeTimeoutMs mtrtlsClientManagementClusterFindEndpointParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrtlsClientManagementClusterFindEndpointParams (mkSelector "setTimedInvokeTimeoutMs:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
...
serverSideProcessingTimeout mtrtlsClientManagementClusterFindEndpointParams  =
    sendMsg mtrtlsClientManagementClusterFindEndpointParams (mkSelector "serverSideProcessingTimeout") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setServerSideProcessingTimeout mtrtlsClientManagementClusterFindEndpointParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrtlsClientManagementClusterFindEndpointParams (mkSelector "setServerSideProcessingTimeout:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
