...
newMode mtrEnergyEVSEModeClusterChangeToModeParams  =
    sendMsg mtrEnergyEVSEModeClusterChangeToModeParams (mkSelector "newMode") (retPtr retVoid) [] >>= ownedObject . castPtr
...
setNewMode mtrEnergyEVSEModeClusterChangeToModeParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrEnergyEVSEModeClusterChangeToModeParams (mkSelector "setNewMode:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
...
timedInvokeTimeoutMs mtrEnergyEVSEModeClusterChangeToModeParams  =
    sendMsg mtrEnergyEVSEModeClusterChangeToModeParams (mkSelector "timedInvokeTimeoutMs") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setTimedInvokeTimeoutMs mtrEnergyEVSEModeClusterChangeToModeParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrEnergyEVSEModeClusterChangeToModeParams (mkSelector "setTimedInvokeTimeoutMs:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
...
serverSideProcessingTimeout mtrEnergyEVSEModeClusterChangeToModeParams  =
    sendMsg mtrEnergyEVSEModeClusterChangeToModeParams (mkSelector "serverSideProcessingTimeout") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setServerSideProcessingTimeout mtrEnergyEVSEModeClusterChangeToModeParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrEnergyEVSEModeClusterChangeToModeParams (mkSelector "setServerSideProcessingTimeout:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
