...
nodeID mtrJointFabricDatastoreClusterRemoveAdminParams  =
    sendMsg mtrJointFabricDatastoreClusterRemoveAdminParams (mkSelector "nodeID") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setNodeID mtrJointFabricDatastoreClusterRemoveAdminParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrJointFabricDatastoreClusterRemoveAdminParams (mkSelector "setNodeID:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
...
timedInvokeTimeoutMs mtrJointFabricDatastoreClusterRemoveAdminParams  =
    sendMsg mtrJointFabricDatastoreClusterRemoveAdminParams (mkSelector "timedInvokeTimeoutMs") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setTimedInvokeTimeoutMs mtrJointFabricDatastoreClusterRemoveAdminParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrJointFabricDatastoreClusterRemoveAdminParams (mkSelector "setTimedInvokeTimeoutMs:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
...
serverSideProcessingTimeout mtrJointFabricDatastoreClusterRemoveAdminParams  =
    sendMsg mtrJointFabricDatastoreClusterRemoveAdminParams (mkSelector "serverSideProcessingTimeout") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setServerSideProcessingTimeout mtrJointFabricDatastoreClusterRemoveAdminParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrJointFabricDatastoreClusterRemoveAdminParams (mkSelector "setServerSideProcessingTimeout:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
