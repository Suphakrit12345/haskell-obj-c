...
ccdid mtrtlsCertificateManagementClusterFindClientCertificateParams  =
    sendMsg mtrtlsCertificateManagementClusterFindClientCertificateParams (mkSelector "ccdid") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setCcdid mtrtlsCertificateManagementClusterFindClientCertificateParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrtlsCertificateManagementClusterFindClientCertificateParams (mkSelector "setCcdid:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
...
timedInvokeTimeoutMs mtrtlsCertificateManagementClusterFindClientCertificateParams  =
    sendMsg mtrtlsCertificateManagementClusterFindClientCertificateParams (mkSelector "timedInvokeTimeoutMs") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setTimedInvokeTimeoutMs mtrtlsCertificateManagementClusterFindClientCertificateParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrtlsCertificateManagementClusterFindClientCertificateParams (mkSelector "setTimedInvokeTimeoutMs:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
...
serverSideProcessingTimeout mtrtlsCertificateManagementClusterFindClientCertificateParams  =
    sendMsg mtrtlsCertificateManagementClusterFindClientCertificateParams (mkSelector "serverSideProcessingTimeout") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setServerSideProcessingTimeout mtrtlsCertificateManagementClusterFindClientCertificateParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrtlsCertificateManagementClusterFindClientCertificateParams (mkSelector "setServerSideProcessingTimeout:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
