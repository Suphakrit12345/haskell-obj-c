...
current mtrThreadNetworkDiagnosticsClusterNetworkFaultChangeEvent  =
    sendMsg mtrThreadNetworkDiagnosticsClusterNetworkFaultChangeEvent (mkSelector "current") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setCurrent mtrThreadNetworkDiagnosticsClusterNetworkFaultChangeEvent  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrThreadNetworkDiagnosticsClusterNetworkFaultChangeEvent (mkSelector "setCurrent:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
...
previous mtrThreadNetworkDiagnosticsClusterNetworkFaultChangeEvent  =
    sendMsg mtrThreadNetworkDiagnosticsClusterNetworkFaultChangeEvent (mkSelector "previous") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setPrevious mtrThreadNetworkDiagnosticsClusterNetworkFaultChangeEvent  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrThreadNetworkDiagnosticsClusterNetworkFaultChangeEvent (mkSelector "setPrevious:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
