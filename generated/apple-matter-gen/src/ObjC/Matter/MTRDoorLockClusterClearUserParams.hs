...
userIndex mtrDoorLockClusterClearUserParams  =
    sendMsg mtrDoorLockClusterClearUserParams (mkSelector "userIndex") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setUserIndex mtrDoorLockClusterClearUserParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrDoorLockClusterClearUserParams (mkSelector "setUserIndex:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
...
timedInvokeTimeoutMs mtrDoorLockClusterClearUserParams  =
    sendMsg mtrDoorLockClusterClearUserParams (mkSelector "timedInvokeTimeoutMs") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setTimedInvokeTimeoutMs mtrDoorLockClusterClearUserParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrDoorLockClusterClearUserParams (mkSelector "setTimedInvokeTimeoutMs:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
...
serverSideProcessingTimeout mtrDoorLockClusterClearUserParams  =
    sendMsg mtrDoorLockClusterClearUserParams (mkSelector "serverSideProcessingTimeout") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setServerSideProcessingTimeout mtrDoorLockClusterClearUserParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrDoorLockClusterClearUserParams (mkSelector "setServerSideProcessingTimeout:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
