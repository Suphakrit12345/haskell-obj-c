...
nonce mtrtlsCertificateManagementClusterClientCSRParams  =
    sendMsg mtrtlsCertificateManagementClusterClientCSRParams (mkSelector "nonce") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setNonce mtrtlsCertificateManagementClusterClientCSRParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrtlsCertificateManagementClusterClientCSRParams (mkSelector "setNonce:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
...
ccdid mtrtlsCertificateManagementClusterClientCSRParams  =
    sendMsg mtrtlsCertificateManagementClusterClientCSRParams (mkSelector "ccdid") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setCcdid mtrtlsCertificateManagementClusterClientCSRParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrtlsCertificateManagementClusterClientCSRParams (mkSelector "setCcdid:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
...
timedInvokeTimeoutMs mtrtlsCertificateManagementClusterClientCSRParams  =
    sendMsg mtrtlsCertificateManagementClusterClientCSRParams (mkSelector "timedInvokeTimeoutMs") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setTimedInvokeTimeoutMs mtrtlsCertificateManagementClusterClientCSRParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrtlsCertificateManagementClusterClientCSRParams (mkSelector "setTimedInvokeTimeoutMs:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
...
serverSideProcessingTimeout mtrtlsCertificateManagementClusterClientCSRParams  =
    sendMsg mtrtlsCertificateManagementClusterClientCSRParams (mkSelector "serverSideProcessingTimeout") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setServerSideProcessingTimeout mtrtlsCertificateManagementClusterClientCSRParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrtlsCertificateManagementClusterClientCSRParams (mkSelector "setServerSideProcessingTimeout:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
