...
arg1 mtrUnitTestingClusterTestListNestedStructListArgumentRequestParams  =
    sendMsg mtrUnitTestingClusterTestListNestedStructListArgumentRequestParams (mkSelector "arg1") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setArg1 mtrUnitTestingClusterTestListNestedStructListArgumentRequestParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrUnitTestingClusterTestListNestedStructListArgumentRequestParams (mkSelector "setArg1:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
...
timedInvokeTimeoutMs mtrUnitTestingClusterTestListNestedStructListArgumentRequestParams  =
    sendMsg mtrUnitTestingClusterTestListNestedStructListArgumentRequestParams (mkSelector "timedInvokeTimeoutMs") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setTimedInvokeTimeoutMs mtrUnitTestingClusterTestListNestedStructListArgumentRequestParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrUnitTestingClusterTestListNestedStructListArgumentRequestParams (mkSelector "setTimedInvokeTimeoutMs:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
...
serverSideProcessingTimeout mtrUnitTestingClusterTestListNestedStructListArgumentRequestParams  =
    sendMsg mtrUnitTestingClusterTestListNestedStructListArgumentRequestParams (mkSelector "serverSideProcessingTimeout") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setServerSideProcessingTimeout mtrUnitTestingClusterTestListNestedStructListArgumentRequestParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrUnitTestingClusterTestListNestedStructListArgumentRequestParams (mkSelector "setServerSideProcessingTimeout:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
