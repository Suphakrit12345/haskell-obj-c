  ...
  withObjCPtr params $ \raw_params ->
    withObjCPtr expectedDataValueDictionaries $ \raw_expectedDataValueDictionaries ->
      withObjCPtr expectedValueIntervalMs $ \raw_expectedValueIntervalMs ->
          sendMsg mtrClusterWaterHeaterMode (mkSelector "changeToModeWithParams:expectedValues:expectedValueInterval:completion:") retVoid [argPtr (castPtr raw_params :: Ptr ()), argPtr (castPtr raw_expectedDataValueDictionaries :: Ptr ()), argPtr (castPtr raw_expectedValueIntervalMs :: Ptr ()), argPtr (castPtr completion :: Ptr ())]
...
readAttributeSupportedModesWithParams mtrClusterWaterHeaterMode  params =
  withObjCPtr params $ \raw_params ->
      sendMsg mtrClusterWaterHeaterMode (mkSelector "readAttributeSupportedModesWithParams:") (retPtr retVoid) [argPtr (castPtr raw_params :: Ptr ())] >>= retainedObject . castPtr
...
readAttributeCurrentModeWithParams mtrClusterWaterHeaterMode  params =
  withObjCPtr params $ \raw_params ->
      sendMsg mtrClusterWaterHeaterMode (mkSelector "readAttributeCurrentModeWithParams:") (retPtr retVoid) [argPtr (castPtr raw_params :: Ptr ())] >>= retainedObject . castPtr
...
readAttributeGeneratedCommandListWithParams mtrClusterWaterHeaterMode  params =
  withObjCPtr params $ \raw_params ->
      sendMsg mtrClusterWaterHeaterMode (mkSelector "readAttributeGeneratedCommandListWithParams:") (retPtr retVoid) [argPtr (castPtr raw_params :: Ptr ())] >>= retainedObject . castPtr
...
readAttributeAcceptedCommandListWithParams mtrClusterWaterHeaterMode  params =
  withObjCPtr params $ \raw_params ->
      sendMsg mtrClusterWaterHeaterMode (mkSelector "readAttributeAcceptedCommandListWithParams:") (retPtr retVoid) [argPtr (castPtr raw_params :: Ptr ())] >>= retainedObject . castPtr
...
readAttributeAttributeListWithParams mtrClusterWaterHeaterMode  params =
  withObjCPtr params $ \raw_params ->
      sendMsg mtrClusterWaterHeaterMode (mkSelector "readAttributeAttributeListWithParams:") (retPtr retVoid) [argPtr (castPtr raw_params :: Ptr ())] >>= retainedObject . castPtr
...
readAttributeFeatureMapWithParams mtrClusterWaterHeaterMode  params =
  withObjCPtr params $ \raw_params ->
      sendMsg mtrClusterWaterHeaterMode (mkSelector "readAttributeFeatureMapWithParams:") (retPtr retVoid) [argPtr (castPtr raw_params :: Ptr ())] >>= retainedObject . castPtr
...
readAttributeClusterRevisionWithParams mtrClusterWaterHeaterMode  params =
  withObjCPtr params $ \raw_params ->
      sendMsg mtrClusterWaterHeaterMode (mkSelector "readAttributeClusterRevisionWithParams:") (retPtr retVoid) [argPtr (castPtr raw_params :: Ptr ())] >>= retainedObject . castPtr
...
init_ mtrClusterWaterHeaterMode  =
    sendMsg mtrClusterWaterHeaterMode (mkSelector "init") (retPtr retVoid) [] >>= ownedObject . castPtr
  ...
  withObjCPtr device $ \raw_device ->
    withObjCPtr endpointID $ \raw_endpointID ->
      withObjCPtr queue $ \raw_queue ->
          sendMsg mtrClusterWaterHeaterMode (mkSelector "initWithDevice:endpointID:queue:") (retPtr retVoid) [argPtr (castPtr raw_device :: Ptr ()), argPtr (castPtr raw_endpointID :: Ptr ()), argPtr (castPtr raw_queue :: Ptr ())] >>= ownedObject . castPtr
