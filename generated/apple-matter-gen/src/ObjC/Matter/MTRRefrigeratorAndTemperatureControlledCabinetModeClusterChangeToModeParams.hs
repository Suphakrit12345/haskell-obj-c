...
newMode mtrRefrigeratorAndTemperatureControlledCabinetModeClusterChangeToModeParams  =
    sendMsg mtrRefrigeratorAndTemperatureControlledCabinetModeClusterChangeToModeParams (mkSelector "newMode") (retPtr retVoid) [] >>= ownedObject . castPtr
...
setNewMode mtrRefrigeratorAndTemperatureControlledCabinetModeClusterChangeToModeParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrRefrigeratorAndTemperatureControlledCabinetModeClusterChangeToModeParams (mkSelector "setNewMode:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
...
timedInvokeTimeoutMs mtrRefrigeratorAndTemperatureControlledCabinetModeClusterChangeToModeParams  =
    sendMsg mtrRefrigeratorAndTemperatureControlledCabinetModeClusterChangeToModeParams (mkSelector "timedInvokeTimeoutMs") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setTimedInvokeTimeoutMs mtrRefrigeratorAndTemperatureControlledCabinetModeClusterChangeToModeParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrRefrigeratorAndTemperatureControlledCabinetModeClusterChangeToModeParams (mkSelector "setTimedInvokeTimeoutMs:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
...
serverSideProcessingTimeout mtrRefrigeratorAndTemperatureControlledCabinetModeClusterChangeToModeParams  =
    sendMsg mtrRefrigeratorAndTemperatureControlledCabinetModeClusterChangeToModeParams (mkSelector "serverSideProcessingTimeout") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setServerSideProcessingTimeout mtrRefrigeratorAndTemperatureControlledCabinetModeClusterChangeToModeParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrRefrigeratorAndTemperatureControlledCabinetModeClusterChangeToModeParams (mkSelector "setServerSideProcessingTimeout:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
