...
returnValue mtrTestClusterClusterTestSimpleArgumentResponseParams  =
    sendMsg mtrTestClusterClusterTestSimpleArgumentResponseParams (mkSelector "returnValue") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setReturnValue mtrTestClusterClusterTestSimpleArgumentResponseParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrTestClusterClusterTestSimpleArgumentResponseParams (mkSelector "setReturnValue:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
...
timedInvokeTimeoutMs mtrTestClusterClusterTestSimpleArgumentResponseParams  =
    sendMsg mtrTestClusterClusterTestSimpleArgumentResponseParams (mkSelector "timedInvokeTimeoutMs") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setTimedInvokeTimeoutMs mtrTestClusterClusterTestSimpleArgumentResponseParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrTestClusterClusterTestSimpleArgumentResponseParams (mkSelector "setTimedInvokeTimeoutMs:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
