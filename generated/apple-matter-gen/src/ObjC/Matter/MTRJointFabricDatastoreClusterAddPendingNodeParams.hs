...
nodeID mtrJointFabricDatastoreClusterAddPendingNodeParams  =
    sendMsg mtrJointFabricDatastoreClusterAddPendingNodeParams (mkSelector "nodeID") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setNodeID mtrJointFabricDatastoreClusterAddPendingNodeParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrJointFabricDatastoreClusterAddPendingNodeParams (mkSelector "setNodeID:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
...
friendlyName mtrJointFabricDatastoreClusterAddPendingNodeParams  =
    sendMsg mtrJointFabricDatastoreClusterAddPendingNodeParams (mkSelector "friendlyName") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setFriendlyName mtrJointFabricDatastoreClusterAddPendingNodeParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrJointFabricDatastoreClusterAddPendingNodeParams (mkSelector "setFriendlyName:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
...
timedInvokeTimeoutMs mtrJointFabricDatastoreClusterAddPendingNodeParams  =
    sendMsg mtrJointFabricDatastoreClusterAddPendingNodeParams (mkSelector "timedInvokeTimeoutMs") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setTimedInvokeTimeoutMs mtrJointFabricDatastoreClusterAddPendingNodeParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrJointFabricDatastoreClusterAddPendingNodeParams (mkSelector "setTimedInvokeTimeoutMs:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
...
serverSideProcessingTimeout mtrJointFabricDatastoreClusterAddPendingNodeParams  =
    sendMsg mtrJointFabricDatastoreClusterAddPendingNodeParams (mkSelector "serverSideProcessingTimeout") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setServerSideProcessingTimeout mtrJointFabricDatastoreClusterAddPendingNodeParams  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrJointFabricDatastoreClusterAddPendingNodeParams (mkSelector "setServerSideProcessingTimeout:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
