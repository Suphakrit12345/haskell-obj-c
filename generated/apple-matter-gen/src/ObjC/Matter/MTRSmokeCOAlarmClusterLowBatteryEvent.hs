...
alarmSeverityLevel mtrSmokeCOAlarmClusterLowBatteryEvent  =
    sendMsg mtrSmokeCOAlarmClusterLowBatteryEvent (mkSelector "alarmSeverityLevel") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setAlarmSeverityLevel mtrSmokeCOAlarmClusterLowBatteryEvent  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrSmokeCOAlarmClusterLowBatteryEvent (mkSelector "setAlarmSeverityLevel:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
