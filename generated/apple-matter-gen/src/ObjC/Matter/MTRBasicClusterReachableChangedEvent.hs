...
reachableNewValue mtrBasicClusterReachableChangedEvent  =
    sendMsg mtrBasicClusterReachableChangedEvent (mkSelector "reachableNewValue") (retPtr retVoid) [] >>= retainedObject . castPtr
...
setReachableNewValue mtrBasicClusterReachableChangedEvent  value =
  withObjCPtr value $ \raw_value ->
      sendMsg mtrBasicClusterReachableChangedEvent (mkSelector "setReachableNewValue:") retVoid [argPtr (castPtr raw_value :: Ptr ())]
