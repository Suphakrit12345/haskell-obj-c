  ...
  do
    ...
    withObjCPtr name $ \raw_name ->
      withObjCPtr address $ \raw_address ->
        sendClassMsg cls' (mkSelector "hostWithName:address:port:") (retPtr retVoid) [argPtr (castPtr raw_name :: Ptr ()), argPtr (castPtr raw_address :: Ptr ()), argCULong port] >>= retainedObject . castPtr
