...
module ObjC.IOBluetooth.NSObject
  ...
  , withL2CAPChannelRef
  , getL2CAPChannelRef
  , readRSSIForDeviceComplete_device_info_error
  , readLinkQualityForDeviceComplete_device_info_error
  ...
  , readRSSIForDeviceComplete_device_info_errorSelector
  , readLinkQualityForDeviceComplete_device_info_errorSelector
...
fileTransferServicesConnectionComplete_error nsObject  inServices inError =
  withObjCPtr inServices $ \raw_inServices ->
      sendMsg nsObject (mkSelector "fileTransferServicesConnectionComplete:error:") retVoid [argPtr (castPtr raw_inServices :: Ptr ()), argCInt inError]
...
fileTransferServicesDisconnectionComplete_error nsObject  inServices inError =
  withObjCPtr inServices $ \raw_inServices ->
      sendMsg nsObject (mkSelector "fileTransferServicesDisconnectionComplete:error:") retVoid [argPtr (castPtr raw_inServices :: Ptr ()), argCInt inError]
...
fileTransferServicesAbortComplete_error nsObject  inServices inError =
  withObjCPtr inServices $ \raw_inServices ->
      sendMsg nsObject (mkSelector "fileTransferServicesAbortComplete:error:") retVoid [argPtr (castPtr raw_inServices :: Ptr ()), argCInt inError]
...
fileTransferServicesRemoveItemComplete_error_removedItem nsObject  inServices inError inItemName =
  withObjCPtr inServices $ \raw_inServices ->
    withObjCPtr inItemName $ \raw_inItemName ->
        sendMsg nsObject (mkSelector "fileTransferServicesRemoveItemComplete:error:removedItem:") retVoid [argPtr (castPtr raw_inServices :: Ptr ()), argCInt inError, argPtr (castPtr raw_inItemName :: Ptr ())]
...
fileTransferServicesCreateFolderComplete_error_folder nsObject  inServices inError inFolderName =
  withObjCPtr inServices $ \raw_inServices ->
    withObjCPtr inFolderName $ \raw_inFolderName ->
        sendMsg nsObject (mkSelector "fileTransferServicesCreateFolderComplete:error:folder:") retVoid [argPtr (castPtr raw_inServices :: Ptr ()), argCInt inError, argPtr (castPtr raw_inFolderName :: Ptr ())]
...
fileTransferServicesPathChangeComplete_error_finalPath nsObject  inServices inError inPath =
  withObjCPtr inServices $ \raw_inServices ->
    withObjCPtr inPath $ \raw_inPath ->
        sendMsg nsObject (mkSelector "fileTransferServicesPathChangeComplete:error:finalPath:") retVoid [argPtr (castPtr raw_inServices :: Ptr ()), argCInt inError, argPtr (castPtr raw_inPath :: Ptr ())]
...
fileTransferServicesRetrieveFolderListingComplete_error_listing nsObject  inServices inError inListing =
  withObjCPtr inServices $ \raw_inServices ->
    withObjCPtr inListing $ \raw_inListing ->
        sendMsg nsObject (mkSelector "fileTransferServicesRetrieveFolderListingComplete:error:listing:") retVoid [argPtr (castPtr raw_inServices :: Ptr ()), argCInt inError, argPtr (castPtr raw_inListing :: Ptr ())]
...
fileTransferServicesFilePreparationComplete_error nsObject  inServices inError =
  withObjCPtr inServices $ \raw_inServices ->
      sendMsg nsObject (mkSelector "fileTransferServicesFilePreparationComplete:error:") retVoid [argPtr (castPtr raw_inServices :: Ptr ()), argCInt inError]
...
fileTransferServicesSendFileComplete_error nsObject  inServices inError =
  withObjCPtr inServices $ \raw_inServices ->
      sendMsg nsObject (mkSelector "fileTransferServicesSendFileComplete:error:") retVoid [argPtr (castPtr raw_inServices :: Ptr ()), argCInt inError]
...
fileTransferServicesCopyRemoteFileComplete_error nsObject  inServices inError =
  withObjCPtr inServices $ \raw_inServices ->
      sendMsg nsObject (mkSelector "fileTransferServicesCopyRemoteFileComplete:error:") retVoid [argPtr (castPtr raw_inServices :: Ptr ()), argCInt inError]
...
--
-- @sender@ — Controller object that sent this delegate message.
--
-- ObjC selector: @- readRSSIForDeviceComplete:device:info:error:@
readRSSIForDeviceComplete_device_info_error :: (IsNSObject nsObject, IsIOBluetoothDevice device) => nsObject -> RawId -> device -> Ptr BluetoothHCIRSSIInfo -> CInt -> IO ()
readRSSIForDeviceComplete_device_info_error nsObject  controller device info error_ =
  withObjCPtr device $ \raw_device ->
      sendMsg nsObject (mkSelector "readRSSIForDeviceComplete:device:info:error:") retVoid [argPtr (castPtr (unRawId controller) :: Ptr ()), argPtr (castPtr raw_device :: Ptr ()), argPtr info, argCInt error_]
...
-- @sender@ — Controller object that sent this delegate message.
--
-- ObjC selector: @- readLinkQualityForDeviceComplete:device:info:error:@
readLinkQualityForDeviceComplete_device_info_error :: (IsNSObject nsObject, IsIOBluetoothDevice device) => nsObject -> RawId -> device -> Ptr BluetoothHCILinkQualityInfo -> CInt -> IO ()
readLinkQualityForDeviceComplete_device_info_error nsObject  controller device info error_ =
  withObjCPtr device $ \raw_device ->
      sendMsg nsObject (mkSelector "readLinkQualityForDeviceComplete:device:info:error:") retVoid [argPtr (castPtr (unRawId controller) :: Ptr ()), argPtr (castPtr raw_device :: Ptr ()), argPtr info, argCInt error_]
...
-- | @Selector@ for @readRSSIForDeviceComplete:device:info:error:@
readRSSIForDeviceComplete_device_info_errorSelector :: Selector
readRSSIForDeviceComplete_device_info_errorSelector = mkSelector "readRSSIForDeviceComplete:device:info:error:"

-- | @Selector@ for @readLinkQualityForDeviceComplete:device:info:error:@
readLinkQualityForDeviceComplete_device_info_errorSelector :: Selector
readLinkQualityForDeviceComplete_device_info_errorSelector = mkSelector "readLinkQualityForDeviceComplete:device:info:error:"
