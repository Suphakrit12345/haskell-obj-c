...
objectAtIndex phFetchResult  index =
    fmap (RawId . castPtr) $ sendMsg phFetchResult (mkSelector "objectAtIndex:") (retPtr retVoid) [argCULong index]
...
objectAtIndexedSubscript phFetchResult  idx =
    fmap (RawId . castPtr) $ sendMsg phFetchResult (mkSelector "objectAtIndexedSubscript:") (retPtr retVoid) [argCULong idx]
