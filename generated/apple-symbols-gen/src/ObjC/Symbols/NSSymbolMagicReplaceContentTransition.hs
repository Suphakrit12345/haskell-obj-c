...
--
-- Generated bindings for @NSSymbolMagicReplaceContentTransition@.
module ObjC.Symbols.NSSymbolMagicReplaceContentTransition
  ( NSSymbolMagicReplaceContentTransition
  , IsNSSymbolMagicReplaceContentTransition(..)
