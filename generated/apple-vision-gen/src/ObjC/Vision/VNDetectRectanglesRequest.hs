...
setMinimumAspectRatio vnDetectRectanglesRequest  value =
    sendMsg vnDetectRectanglesRequest (mkSelector "setMinimumAspectRatio:") retVoid [argCFloat value]
...
setMaximumAspectRatio vnDetectRectanglesRequest  value =
    sendMsg vnDetectRectanglesRequest (mkSelector "setMaximumAspectRatio:") retVoid [argCFloat value]
...
setQuadratureTolerance vnDetectRectanglesRequest  value =
    sendMsg vnDetectRectanglesRequest (mkSelector "setQuadratureTolerance:") retVoid [argCFloat value]
...
setMinimumSize vnDetectRectanglesRequest  value =
    sendMsg vnDetectRectanglesRequest (mkSelector "setMinimumSize:") retVoid [argCFloat value]
...
setMinimumConfidence vnDetectRectanglesRequest  value =
    sendMsg vnDetectRectanglesRequest (mkSelector "setMinimumConfidence:") retVoid [argCFloat value]
...
setMaximumObservations vnDetectRectanglesRequest  value =
    sendMsg vnDetectRectanglesRequest (mkSelector "setMaximumObservations:") retVoid [argCULong value]
