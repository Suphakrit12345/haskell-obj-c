...
tiffRepresentationOfImage_format_colorSpace_options ciContext  image format colorSpace options =
  withObjCPtr image $ \raw_image ->
    withObjCPtr options $ \raw_options ->
        sendMsg ciContext (mkSelector "TIFFRepresentationOfImage:format:colorSpace:options:") (retPtr retVoid) [argPtr (castPtr raw_image :: Ptr ()), argCInt format, argPtr colorSpace, argPtr (castPtr raw_options :: Ptr ())] >>= retainedObject . castPtr
...
heifRepresentationOfImage_format_colorSpace_options ciContext  image format colorSpace options =
  withObjCPtr image $ \raw_image ->
    withObjCPtr options $ \raw_options ->
        sendMsg ciContext (mkSelector "HEIFRepresentationOfImage:format:colorSpace:options:") (retPtr retVoid) [argPtr (castPtr raw_image :: Ptr ()), argCInt format, argPtr colorSpace, argPtr (castPtr raw_options :: Ptr ())] >>= retainedObject . castPtr
...
pngRepresentationOfImage_format_colorSpace_options ciContext  image format colorSpace options =
  withObjCPtr image $ \raw_image ->
    withObjCPtr options $ \raw_options ->
        sendMsg ciContext (mkSelector "PNGRepresentationOfImage:format:colorSpace:options:") (retPtr retVoid) [argPtr (castPtr raw_image :: Ptr ()), argCInt format, argPtr colorSpace, argPtr (castPtr raw_options :: Ptr ())] >>= retainedObject . castPtr
...
writeTIFFRepresentationOfImage_toURL_format_colorSpace_options_error ciContext  image url format colorSpace options errorPtr =
  withObjCPtr image $ \raw_image ->
    withObjCPtr url $ \raw_url ->
      withObjCPtr options $ \raw_options ->
        withObjCPtr errorPtr $ \raw_errorPtr ->
            fmap ((/= 0) :: CULong -> Bool) $ sendMsg ciContext (mkSelector "writeTIFFRepresentationOfImage:toURL:format:colorSpace:options:error:") retCULong [argPtr (castPtr raw_image :: Ptr ()), argPtr (castPtr raw_url :: Ptr ()), argCInt format, argPtr colorSpace, argPtr (castPtr raw_options :: Ptr ()), argPtr (castPtr raw_errorPtr :: Ptr ())]
...
writePNGRepresentationOfImage_toURL_format_colorSpace_options_error ciContext  image url format colorSpace options errorPtr =
  withObjCPtr image $ \raw_image ->
    withObjCPtr url $ \raw_url ->
      withObjCPtr options $ \raw_options ->
        withObjCPtr errorPtr $ \raw_errorPtr ->
            fmap ((/= 0) :: CULong -> Bool) $ sendMsg ciContext (mkSelector "writePNGRepresentationOfImage:toURL:format:colorSpace:options:error:") retCULong [argPtr (castPtr raw_image :: Ptr ()), argPtr (castPtr raw_url :: Ptr ()), argCInt format, argPtr colorSpace, argPtr (castPtr raw_options :: Ptr ()), argPtr (castPtr raw_errorPtr :: Ptr ())]
...
writeHEIFRepresentationOfImage_toURL_format_colorSpace_options_error ciContext  image url format colorSpace options errorPtr =
  withObjCPtr image $ \raw_image ->
    withObjCPtr url $ \raw_url ->
      withObjCPtr options $ \raw_options ->
        withObjCPtr errorPtr $ \raw_errorPtr ->
            fmap ((/= 0) :: CULong -> Bool) $ sendMsg ciContext (mkSelector "writeHEIFRepresentationOfImage:toURL:format:colorSpace:options:error:") retCULong [argPtr (castPtr raw_image :: Ptr ()), argPtr (castPtr raw_url :: Ptr ()), argCInt format, argPtr colorSpace, argPtr (castPtr raw_options :: Ptr ()), argPtr (castPtr raw_errorPtr :: Ptr ())]
...
contextForOfflineGPUAtIndex index =
  do
    cls' <- getRequiredClass "CIContext"
    sendClassMsg cls' (mkSelector "contextForOfflineGPUAtIndex:") (retPtr retVoid) [argCUInt index] >>= retainedObject . castPtr
...
contextForOfflineGPUAtIndex_colorSpace_options_sharedContext index colorSpace options sharedContext =
  do
    cls' <- getRequiredClass "CIContext"
    withObjCPtr options $ \raw_options ->
      sendClassMsg cls' (mkSelector "contextForOfflineGPUAtIndex:colorSpace:options:sharedContext:") (retPtr retVoid) [argCUInt index, argPtr colorSpace, argPtr (castPtr raw_options :: Ptr ()), argPtr sharedContext] >>= retainedObject . castPtr
