...
vectorWithValues_count values count =
  do
    ...
    sendClassMsg cls' (mkSelector "vectorWithValues:count:") (retPtr retVoid) [argPtr (unConst values), argCULong count] >>= retainedObject . castPtr
...
vectorWithX x =
  do
    cls' <- getRequiredClass "CIVector"
    sendClassMsg cls' (mkSelector "vectorWithX:") (retPtr retVoid) [argCDouble x] >>= retainedObject . castPtr
...
vectorWithX_Y x y =
  do
    cls' <- getRequiredClass "CIVector"
    sendClassMsg cls' (mkSelector "vectorWithX:Y:") (retPtr retVoid) [argCDouble x, argCDouble y] >>= retainedObject . castPtr
...
vectorWithX_Y_Z x y z =
  do
    cls' <- getRequiredClass "CIVector"
    sendClassMsg cls' (mkSelector "vectorWithX:Y:Z:") (retPtr retVoid) [argCDouble x, argCDouble y, argCDouble z] >>= retainedObject . castPtr
...
vectorWithX_Y_Z_W x y z w =
  do
    cls' <- getRequiredClass "CIVector"
    sendClassMsg cls' (mkSelector "vectorWithX:Y:Z:W:") (retPtr retVoid) [argCDouble x, argCDouble y, argCDouble z, argCDouble w] >>= retainedObject . castPtr
...
initWithValues_count ciVector  values count =
    sendMsg ciVector (mkSelector "initWithValues:count:") (retPtr retVoid) [argPtr (unConst values), argCULong count] >>= ownedObject . castPtr
...
initWithX ciVector  x =
    sendMsg ciVector (mkSelector "initWithX:") (retPtr retVoid) [argCDouble x] >>= ownedObject . castPtr
...
initWithX_Y ciVector  x y =
    sendMsg ciVector (mkSelector "initWithX:Y:") (retPtr retVoid) [argCDouble x, argCDouble y] >>= ownedObject . castPtr
...
initWithX_Y_Z ciVector  x y z =
    sendMsg ciVector (mkSelector "initWithX:Y:Z:") (retPtr retVoid) [argCDouble x, argCDouble y, argCDouble z] >>= ownedObject . castPtr
...
initWithX_Y_Z_W ciVector  x y z w =
    sendMsg ciVector (mkSelector "initWithX:Y:Z:W:") (retPtr retVoid) [argCDouble x, argCDouble y, argCDouble z, argCDouble w] >>= ownedObject . castPtr
...
valueAtIndex ciVector  index =
    sendMsg ciVector (mkSelector "valueAtIndex:") retCDouble [argCULong index]
