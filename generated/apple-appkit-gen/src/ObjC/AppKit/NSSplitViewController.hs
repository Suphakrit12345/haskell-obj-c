...
insertSplitViewItem_atIndex nsSplitViewController  splitViewItem index =
  withObjCPtr splitViewItem $ \raw_splitViewItem ->
      sendMsg nsSplitViewController (mkSelector "insertSplitViewItem:atIndex:") retVoid [argPtr (castPtr raw_splitViewItem :: Ptr ()), argCLong index]
...
splitView_shouldCollapseSubview_forDoubleClickOnDividerAtIndex nsSplitViewController  splitView subview dividerIndex =
  withObjCPtr splitView $ \raw_splitView ->
    withObjCPtr subview $ \raw_subview ->
        fmap ((/= 0) :: CULong -> Bool) $ sendMsg nsSplitViewController (mkSelector "splitView:shouldCollapseSubview:forDoubleClickOnDividerAtIndex:") retCULong [argPtr (castPtr raw_splitView :: Ptr ()), argPtr (castPtr raw_subview :: Ptr ()), argCLong dividerIndex]
...
splitView_shouldHideDividerAtIndex nsSplitViewController  splitView dividerIndex =
  withObjCPtr splitView $ \raw_splitView ->
      fmap ((/= 0) :: CULong -> Bool) $ sendMsg nsSplitViewController (mkSelector "splitView:shouldHideDividerAtIndex:") retCULong [argPtr (castPtr raw_splitView :: Ptr ()), argCLong dividerIndex]
...
splitView_effectiveRect_forDrawnRect_ofDividerAtIndex nsSplitViewController  splitView proposedEffectiveRect drawnRect dividerIndex =
  withObjCPtr splitView $ \raw_splitView ->
      sendMsgStret nsSplitViewController (mkSelector "splitView:effectiveRect:forDrawnRect:ofDividerAtIndex:") retNSRect [argPtr (castPtr raw_splitView :: Ptr ()), argNSRect proposedEffectiveRect, argNSRect drawnRect, argCLong dividerIndex]
...
splitView_additionalEffectiveRectOfDividerAtIndex nsSplitViewController  splitView dividerIndex =
  withObjCPtr splitView $ \raw_splitView ->
      sendMsgStret nsSplitViewController (mkSelector "splitView:additionalEffectiveRectOfDividerAtIndex:") retNSRect [argPtr (castPtr raw_splitView :: Ptr ()), argCLong dividerIndex]
...
setMinimumThicknessForInlineSidebars nsSplitViewController  value =
    sendMsg nsSplitViewController (mkSelector "setMinimumThicknessForInlineSidebars:") retVoid [argCDouble value]
