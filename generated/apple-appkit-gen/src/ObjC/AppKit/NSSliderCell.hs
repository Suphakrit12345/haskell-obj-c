...
setKnobThickness nsSliderCell  thickness =
    sendMsg nsSliderCell (mkSelector "setKnobThickness:") retVoid [argCDouble thickness]
...
tickMarkValueAtIndex nsSliderCell  index =
    sendMsg nsSliderCell (mkSelector "tickMarkValueAtIndex:") retCDouble [argCLong index]

-- | @- rectOfTickMarkAtIndex:@
rectOfTickMarkAtIndex :: IsNSSliderCell nsSliderCell => nsSliderCell -> CLong -> IO NSRect
rectOfTickMarkAtIndex nsSliderCell  index =
    sendMsgStret nsSliderCell (mkSelector "rectOfTickMarkAtIndex:") retNSRect [argCLong index]
...
closestTickMarkValueToValue nsSliderCell  value =
    sendMsg nsSliderCell (mkSelector "closestTickMarkValueToValue:") retCDouble [argCDouble value]
...
setMinValue nsSliderCell  value =
    sendMsg nsSliderCell (mkSelector "setMinValue:") retVoid [argCDouble value]
...
setMaxValue nsSliderCell  value =
    sendMsg nsSliderCell (mkSelector "setMaxValue:") retVoid [argCDouble value]
...
setAltIncrementValue nsSliderCell  value =
    sendMsg nsSliderCell (mkSelector "setAltIncrementValue:") retVoid [argCDouble value]
...
setNumberOfTickMarks nsSliderCell  value =
    sendMsg nsSliderCell (mkSelector "setNumberOfTickMarks:") retVoid [argCLong value]
