...
fractionalWidthDimension fractionalWidth =
  do
    ...
    sendClassMsg cls' (mkSelector "fractionalWidthDimension:") (retPtr retVoid) [argCDouble fractionalWidth] >>= retainedObject . castPtr
...
fractionalHeightDimension fractionalHeight =
  do
    cls' <- getRequiredClass "NSCollectionLayoutDimension"
    sendClassMsg cls' (mkSelector "fractionalHeightDimension:") (retPtr retVoid) [argCDouble fractionalHeight] >>= retainedObject . castPtr
...
absoluteDimension absoluteDimension =
  do
    cls' <- getRequiredClass "NSCollectionLayoutDimension"
    sendClassMsg cls' (mkSelector "absoluteDimension:") (retPtr retVoid) [argCDouble absoluteDimension] >>= retainedObject . castPtr
...
estimatedDimension estimatedDimension =
  do
    cls' <- getRequiredClass "NSCollectionLayoutDimension"
    sendClassMsg cls' (mkSelector "estimatedDimension:") (retPtr retVoid) [argCDouble estimatedDimension] >>= retainedObject . castPtr
