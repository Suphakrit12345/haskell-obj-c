  ...
  do
    ...
    withObjCPtr layoutSize $ \raw_layoutSize ->
      withObjCPtr subitem $ \raw_subitem ->
        sendClassMsg cls' (mkSelector "horizontalGroupWithLayoutSize:subitem:count:") (retPtr retVoid) [argPtr (castPtr raw_layoutSize :: Ptr ()), argPtr (castPtr raw_subitem :: Ptr ()), argCLong count] >>= retainedObject . castPtr
...
verticalGroupWithLayoutSize_subitem_count layoutSize subitem count =
  do
    ...
    withObjCPtr layoutSize $ \raw_layoutSize ->
      withObjCPtr subitem $ \raw_subitem ->
        sendClassMsg cls' (mkSelector "verticalGroupWithLayoutSize:subitem:count:") (retPtr retVoid) [argPtr (castPtr raw_layoutSize :: Ptr ()), argPtr (castPtr raw_subitem :: Ptr ()), argCLong count] >>= retainedObject . castPtr
