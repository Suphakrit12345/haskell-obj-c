...
setImage_atIndex nsPickerTouchBarItem  image index =
  withObjCPtr image $ \raw_image ->
      sendMsg nsPickerTouchBarItem (mkSelector "setImage:atIndex:") retVoid [argPtr (castPtr raw_image :: Ptr ()), argCLong index]
...
imageAtIndex nsPickerTouchBarItem  index =
    sendMsg nsPickerTouchBarItem (mkSelector "imageAtIndex:") (retPtr retVoid) [argCLong index] >>= retainedObject . castPtr
...
setLabel_atIndex nsPickerTouchBarItem  label index =
  withObjCPtr label $ \raw_label ->
      sendMsg nsPickerTouchBarItem (mkSelector "setLabel:atIndex:") retVoid [argPtr (castPtr raw_label :: Ptr ()), argCLong index]
...
labelAtIndex nsPickerTouchBarItem  index =
    sendMsg nsPickerTouchBarItem (mkSelector "labelAtIndex:") (retPtr retVoid) [argCLong index] >>= retainedObject . castPtr
...
setEnabled_atIndex nsPickerTouchBarItem  enabled index =
    sendMsg nsPickerTouchBarItem (mkSelector "setEnabled:atIndex:") retVoid [argCULong (if enabled then 1 else 0), argCLong index]
...
isEnabledAtIndex nsPickerTouchBarItem  index =
    fmap ((/= 0) :: CULong -> Bool) $ sendMsg nsPickerTouchBarItem (mkSelector "isEnabledAtIndex:") retCULong [argCLong index]
...
setSelectedIndex nsPickerTouchBarItem  value =
    sendMsg nsPickerTouchBarItem (mkSelector "setSelectedIndex:") retVoid [argCLong value]
...
setNumberOfOptions nsPickerTouchBarItem  value =
    sendMsg nsPickerTouchBarItem (mkSelector "setNumberOfOptions:") retVoid [argCLong value]
