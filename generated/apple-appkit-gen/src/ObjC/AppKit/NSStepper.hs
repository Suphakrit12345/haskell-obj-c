...
setMinValue nsStepper  value =
    sendMsg nsStepper (mkSelector "setMinValue:") retVoid [argCDouble value]
...
setMaxValue nsStepper  value =
    sendMsg nsStepper (mkSelector "setMaxValue:") retVoid [argCDouble value]
...
setIncrement nsStepper  value =
    sendMsg nsStepper (mkSelector "setIncrement:") retVoid [argCDouble value]
