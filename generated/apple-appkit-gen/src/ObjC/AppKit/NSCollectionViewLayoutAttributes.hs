...
setAlpha nsCollectionViewLayoutAttributes  value =
    sendMsg nsCollectionViewLayoutAttributes (mkSelector "setAlpha:") retVoid [argCDouble value]
...
setZIndex nsCollectionViewLayoutAttributes  value =
    sendMsg nsCollectionViewLayoutAttributes (mkSelector "setZIndex:") retVoid [argCLong value]
