...
rectOfTickMarkAtIndex nsLevelIndicatorCell  index =
    sendMsgStret nsLevelIndicatorCell (mkSelector "rectOfTickMarkAtIndex:") retNSRect [argCLong index]
...
tickMarkValueAtIndex nsLevelIndicatorCell  index =
    sendMsg nsLevelIndicatorCell (mkSelector "tickMarkValueAtIndex:") retCDouble [argCLong index]
...
setMinValue nsLevelIndicatorCell  value =
    sendMsg nsLevelIndicatorCell (mkSelector "setMinValue:") retVoid [argCDouble value]
...
setMaxValue nsLevelIndicatorCell  value =
    sendMsg nsLevelIndicatorCell (mkSelector "setMaxValue:") retVoid [argCDouble value]
...
setWarningValue nsLevelIndicatorCell  value =
    sendMsg nsLevelIndicatorCell (mkSelector "setWarningValue:") retVoid [argCDouble value]
...
setCriticalValue nsLevelIndicatorCell  value =
    sendMsg nsLevelIndicatorCell (mkSelector "setCriticalValue:") retVoid [argCDouble value]
...
setNumberOfTickMarks nsLevelIndicatorCell  value =
    sendMsg nsLevelIndicatorCell (mkSelector "setNumberOfTickMarks:") retVoid [argCLong value]
...
setNumberOfMajorTickMarks nsLevelIndicatorCell  value =
    sendMsg nsLevelIndicatorCell (mkSelector "setNumberOfMajorTickMarks:") retVoid [argCLong value]
