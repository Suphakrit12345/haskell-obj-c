...
setMagnification_centeredAtPoint nsScrollView  magnification point =
    sendMsg nsScrollView (mkSelector "setMagnification:centeredAtPoint:") retVoid [argCDouble magnification, argNSPoint point]
...
setHorizontalLineScroll nsScrollView  value =
    sendMsg nsScrollView (mkSelector "setHorizontalLineScroll:") retVoid [argCDouble value]
...
setVerticalLineScroll nsScrollView  value =
    sendMsg nsScrollView (mkSelector "setVerticalLineScroll:") retVoid [argCDouble value]
...
setLineScroll nsScrollView  value =
    sendMsg nsScrollView (mkSelector "setLineScroll:") retVoid [argCDouble value]
...
setHorizontalPageScroll nsScrollView  value =
    sendMsg nsScrollView (mkSelector "setHorizontalPageScroll:") retVoid [argCDouble value]
...
setVerticalPageScroll nsScrollView  value =
    sendMsg nsScrollView (mkSelector "setVerticalPageScroll:") retVoid [argCDouble value]
...
setPageScroll nsScrollView  value =
    sendMsg nsScrollView (mkSelector "setPageScroll:") retVoid [argCDouble value]
...
setMagnification nsScrollView  value =
    sendMsg nsScrollView (mkSelector "setMagnification:") retVoid [argCDouble value]
...
setMaxMagnification nsScrollView  value =
    sendMsg nsScrollView (mkSelector "setMaxMagnification:") retVoid [argCDouble value]
...
setMinMagnification nsScrollView  value =
    sendMsg nsScrollView (mkSelector "setMinMagnification:") retVoid [argCDouble value]
