...
selectSegmentWithTag nsSegmentedCell  tag =
    fmap ((/= 0) :: CULong -> Bool) $ sendMsg nsSegmentedCell (mkSelector "selectSegmentWithTag:") retCULong [argCLong tag]
...
setWidth_forSegment nsSegmentedCell  width segment =
    sendMsg nsSegmentedCell (mkSelector "setWidth:forSegment:") retVoid [argCDouble width, argCLong segment]
...
widthForSegment nsSegmentedCell  segment =
    sendMsg nsSegmentedCell (mkSelector "widthForSegment:") retCDouble [argCLong segment]
...
setImage_forSegment nsSegmentedCell  image segment =
  withObjCPtr image $ \raw_image ->
      sendMsg nsSegmentedCell (mkSelector "setImage:forSegment:") retVoid [argPtr (castPtr raw_image :: Ptr ()), argCLong segment]
...
imageForSegment nsSegmentedCell  segment =
    sendMsg nsSegmentedCell (mkSelector "imageForSegment:") (retPtr retVoid) [argCLong segment] >>= retainedObject . castPtr
...
setImageScaling_forSegment nsSegmentedCell  scaling segment =
    sendMsg nsSegmentedCell (mkSelector "setImageScaling:forSegment:") retVoid [argCULong (coerce scaling), argCLong segment]
...
imageScalingForSegment nsSegmentedCell  segment =
    fmap (coerce :: CULong -> NSImageScaling) $ sendMsg nsSegmentedCell (mkSelector "imageScalingForSegment:") retCULong [argCLong segment]
...
setLabel_forSegment nsSegmentedCell  label segment =
  withObjCPtr label $ \raw_label ->
      sendMsg nsSegmentedCell (mkSelector "setLabel:forSegment:") retVoid [argPtr (castPtr raw_label :: Ptr ()), argCLong segment]
...
labelForSegment nsSegmentedCell  segment =
    sendMsg nsSegmentedCell (mkSelector "labelForSegment:") (retPtr retVoid) [argCLong segment] >>= retainedObject . castPtr
...
setSelected_forSegment nsSegmentedCell  selected segment =
    sendMsg nsSegmentedCell (mkSelector "setSelected:forSegment:") retVoid [argCULong (if selected then 1 else 0), argCLong segment]
...
isSelectedForSegment nsSegmentedCell  segment =
    fmap ((/= 0) :: CULong -> Bool) $ sendMsg nsSegmentedCell (mkSelector "isSelectedForSegment:") retCULong [argCLong segment]
...
setEnabled_forSegment nsSegmentedCell  enabled segment =
    sendMsg nsSegmentedCell (mkSelector "setEnabled:forSegment:") retVoid [argCULong (if enabled then 1 else 0), argCLong segment]
...
isEnabledForSegment nsSegmentedCell  segment =
    fmap ((/= 0) :: CULong -> Bool) $ sendMsg nsSegmentedCell (mkSelector "isEnabledForSegment:") retCULong [argCLong segment]
...
setMenu_forSegment nsSegmentedCell  menu segment =
  withObjCPtr menu $ \raw_menu ->
      sendMsg nsSegmentedCell (mkSelector "setMenu:forSegment:") retVoid [argPtr (castPtr raw_menu :: Ptr ()), argCLong segment]
...
menuForSegment nsSegmentedCell  segment =
    sendMsg nsSegmentedCell (mkSelector "menuForSegment:") (retPtr retVoid) [argCLong segment] >>= retainedObject . castPtr
...
setToolTip_forSegment nsSegmentedCell  toolTip segment =
  withObjCPtr toolTip $ \raw_toolTip ->
      sendMsg nsSegmentedCell (mkSelector "setToolTip:forSegment:") retVoid [argPtr (castPtr raw_toolTip :: Ptr ()), argCLong segment]
...
toolTipForSegment nsSegmentedCell  segment =
    sendMsg nsSegmentedCell (mkSelector "toolTipForSegment:") (retPtr retVoid) [argCLong segment] >>= retainedObject . castPtr
...
setTag_forSegment nsSegmentedCell  tag segment =
    sendMsg nsSegmentedCell (mkSelector "setTag:forSegment:") retVoid [argCLong tag, argCLong segment]

-- | @- tagForSegment:@
tagForSegment :: IsNSSegmentedCell nsSegmentedCell => nsSegmentedCell -> CLong -> IO CLong
tagForSegment nsSegmentedCell  segment =
    sendMsg nsSegmentedCell (mkSelector "tagForSegment:") retCLong [argCLong segment]
...
drawSegment_inFrame_withView nsSegmentedCell  segment frame controlView =
  withObjCPtr controlView $ \raw_controlView ->
      sendMsg nsSegmentedCell (mkSelector "drawSegment:inFrame:withView:") retVoid [argCLong segment, argNSRect frame, argPtr (castPtr raw_controlView :: Ptr ())]
...
interiorBackgroundStyleForSegment nsSegmentedCell  segment =
    fmap (coerce :: CLong -> NSBackgroundStyle) $ sendMsg nsSegmentedCell (mkSelector "interiorBackgroundStyleForSegment:") retCLong [argCLong segment]
...
setSegmentCount nsSegmentedCell  value =
    sendMsg nsSegmentedCell (mkSelector "setSegmentCount:") retVoid [argCLong value]
...
setSelectedSegment nsSegmentedCell  value =
    sendMsg nsSegmentedCell (mkSelector "setSelectedSegment:") retVoid [argCLong value]
