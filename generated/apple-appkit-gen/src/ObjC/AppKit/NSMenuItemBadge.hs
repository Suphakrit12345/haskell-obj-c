...
updatesWithCount itemCount =
  do
    ...
    sendClassMsg cls' (mkSelector "updatesWithCount:") (retPtr retVoid) [argCLong itemCount] >>= retainedObject . castPtr
...
newItemsWithCount itemCount =
  do
    cls' <- getRequiredClass "NSMenuItemBadge"
    sendClassMsg cls' (mkSelector "newItemsWithCount:") (retPtr retVoid) [argCLong itemCount] >>= ownedObject . castPtr
...
alertsWithCount itemCount =
  do
    cls' <- getRequiredClass "NSMenuItemBadge"
    sendClassMsg cls' (mkSelector "alertsWithCount:") (retPtr retVoid) [argCLong itemCount] >>= retainedObject . castPtr
...
initWithCount_type nsMenuItemBadge  itemCount type_ =
    sendMsg nsMenuItemBadge (mkSelector "initWithCount:type:") (retPtr retVoid) [argCLong itemCount, argCLong (coerce type_)] >>= ownedObject . castPtr
...
initWithCount nsMenuItemBadge  itemCount =
    sendMsg nsMenuItemBadge (mkSelector "initWithCount:") (retPtr retVoid) [argCLong itemCount] >>= ownedObject . castPtr
