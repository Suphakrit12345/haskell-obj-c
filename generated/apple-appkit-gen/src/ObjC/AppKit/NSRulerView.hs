      ...
      withObjCPtr abbreviation $ \raw_abbreviation ->
        withObjCPtr stepUpCycle $ \raw_stepUpCycle ->
          withObjCPtr stepDownCycle $ \raw_stepDownCycle ->
            sendClassMsg cls' (mkSelector "registerUnitWithName:abbreviation:unitToPointsConversionFactor:stepUpCycle:stepDownCycle:") retVoid [argPtr (castPtr raw_unitName :: Ptr ()), argPtr (castPtr raw_abbreviation :: Ptr ()), argCDouble conversionFactor, argPtr (castPtr raw_stepUpCycle :: Ptr ()), argPtr (castPtr raw_stepDownCycle :: Ptr ())]
...
moveRulerlineFromLocation_toLocation nsRulerView  oldLocation newLocation =
    sendMsg nsRulerView (mkSelector "moveRulerlineFromLocation:toLocation:") retVoid [argCDouble oldLocation, argCDouble newLocation]
...
setRuleThickness nsRulerView  value =
    sendMsg nsRulerView (mkSelector "setRuleThickness:") retVoid [argCDouble value]
...
setReservedThicknessForMarkers nsRulerView  value =
    sendMsg nsRulerView (mkSelector "setReservedThicknessForMarkers:") retVoid [argCDouble value]
...
setReservedThicknessForAccessoryView nsRulerView  value =
    sendMsg nsRulerView (mkSelector "setReservedThicknessForAccessoryView:") retVoid [argCDouble value]
...
setOriginOffset nsRulerView  value =
    sendMsg nsRulerView (mkSelector "setOriginOffset:") retVoid [argCDouble value]
