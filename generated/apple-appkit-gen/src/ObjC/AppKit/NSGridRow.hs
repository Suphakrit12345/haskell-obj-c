...
cellAtIndex nsGridRow  index =
    sendMsg nsGridRow (mkSelector "cellAtIndex:") (retPtr retVoid) [argCLong index] >>= retainedObject . castPtr
...
setHeight nsGridRow  value =
    sendMsg nsGridRow (mkSelector "setHeight:") retVoid [argCDouble value]
...
setTopPadding nsGridRow  value =
    sendMsg nsGridRow (mkSelector "setTopPadding:") retVoid [argCDouble value]
...
setBottomPadding nsGridRow  value =
    sendMsg nsGridRow (mkSelector "setBottomPadding:") retVoid [argCDouble value]
