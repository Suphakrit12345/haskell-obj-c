...
initWithDevice_kernelWidth_kernelHeight_dilationRateX_dilationRateY_strideInPixelsX_strideInPixelsY mpscnnDilatedPoolingMaxGradient  device kernelWidth kernelHeight dilationRateX dilationRateY strideInPixelsX strideInPixelsY =
    sendMsg mpscnnDilatedPoolingMaxGradient (mkSelector "initWithDevice:kernelWidth:kernelHeight:dilationRateX:dilationRateY:strideInPixelsX:strideInPixelsY:") (retPtr retVoid) [argPtr (castPtr (unRawId device) :: Ptr ()), argCULong kernelWidth, argCULong kernelHeight, argCULong dilationRateX, argCULong dilationRateY, argCULong strideInPixelsX, argCULong strideInPixelsY] >>= ownedObject . castPtr
...
initWithDevice_kernelWidth_kernelHeight_strideInPixelsX_strideInPixelsY mpscnnDilatedPoolingMaxGradient  device kernelWidth kernelHeight strideInPixelsX strideInPixelsY =
    sendMsg mpscnnDilatedPoolingMaxGradient (mkSelector "initWithDevice:kernelWidth:kernelHeight:strideInPixelsX:strideInPixelsY:") (retPtr retVoid) [argPtr (castPtr (unRawId device) :: Ptr ()), argCULong kernelWidth, argCULong kernelHeight, argCULong strideInPixelsX, argCULong strideInPixelsY] >>= ownedObject . castPtr
