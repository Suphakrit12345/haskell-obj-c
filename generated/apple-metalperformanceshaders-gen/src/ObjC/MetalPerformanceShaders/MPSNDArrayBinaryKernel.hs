...
initWithDevice_sourceCount mpsndArrayBinaryKernel  device count =
    sendMsg mpsndArrayBinaryKernel (mkSelector "initWithDevice:sourceCount:") (retPtr retVoid) [argPtr (castPtr (unRawId device) :: Ptr ()), argCULong count] >>= ownedObject . castPtr
