...
initWithSource_a_b mpscnnNeuronTanHNode  sourceNode a b =
  withObjCPtr sourceNode $ \raw_sourceNode ->
      sendMsg mpscnnNeuronTanHNode (mkSelector "initWithSource:a:b:") (retPtr retVoid) [argPtr (castPtr raw_sourceNode :: Ptr ()), argCFloat a, argCFloat b] >>= ownedObject . castPtr
