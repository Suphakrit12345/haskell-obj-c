...
nodeWithSource_a_b_c sourceNode a b c =
  do
    ...
    withObjCPtr sourceNode $ \raw_sourceNode ->
      sendClassMsg cls' (mkSelector "nodeWithSource:a:b:c:") (retPtr retVoid) [argPtr (castPtr raw_sourceNode :: Ptr ()), argCFloat a, argCFloat b, argCFloat c] >>= retainedObject . castPtr
...
initWithSource_a_b_c mpscnnNeuronExponentialNode  sourceNode a b c =
  withObjCPtr sourceNode $ \raw_sourceNode ->
      sendMsg mpscnnNeuronExponentialNode (mkSelector "initWithSource:a:b:c:") (retPtr retVoid) [argPtr (castPtr raw_sourceNode :: Ptr ()), argCFloat a, argCFloat b, argCFloat c] >>= ownedObject . castPtr
