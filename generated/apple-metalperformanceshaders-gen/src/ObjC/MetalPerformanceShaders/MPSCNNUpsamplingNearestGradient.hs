...
initWithDevice_integerScaleFactorX_integerScaleFactorY mpscnnUpsamplingNearestGradient  device integerScaleFactorX integerScaleFactorY =
    sendMsg mpscnnUpsamplingNearestGradient (mkSelector "initWithDevice:integerScaleFactorX:integerScaleFactorY:") (retPtr retVoid) [argPtr (castPtr (unRawId device) :: Ptr ()), argCULong integerScaleFactorX, argCULong integerScaleFactorY] >>= ownedObject . castPtr
