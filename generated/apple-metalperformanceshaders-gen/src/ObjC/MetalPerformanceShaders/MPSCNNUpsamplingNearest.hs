...
initWithDevice_integerScaleFactorX_integerScaleFactorY mpscnnUpsamplingNearest  device integerScaleFactorX integerScaleFactorY =
    sendMsg mpscnnUpsamplingNearest (mkSelector "initWithDevice:integerScaleFactorX:integerScaleFactorY:") (retPtr retVoid) [argPtr (castPtr (unRawId device) :: Ptr ()), argCULong integerScaleFactorX, argCULong integerScaleFactorY] >>= ownedObject . castPtr
