...
initWithSource_a_b mpscnnNeuronLinearNode  sourceNode a b =
  withObjCPtr sourceNode $ \raw_sourceNode ->
      sendMsg mpscnnNeuronLinearNode (mkSelector "initWithSource:a:b:") (retPtr retVoid) [argPtr (castPtr raw_sourceNode :: Ptr ()), argCFloat a, argCFloat b] >>= ownedObject . castPtr
