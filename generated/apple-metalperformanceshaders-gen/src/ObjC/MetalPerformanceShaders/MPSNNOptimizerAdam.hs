...
initWithDevice_learningRate mpsnnOptimizerAdam  device learningRate =
    sendMsg mpsnnOptimizerAdam (mkSelector "initWithDevice:learningRate:") (retPtr retVoid) [argPtr (castPtr (unRawId device) :: Ptr ()), argCFloat learningRate] >>= ownedObject . castPtr
...
initWithDevice_beta1_beta2_epsilon_timeStep_optimizerDescriptor mpsnnOptimizerAdam  device beta1 beta2 epsilon timeStep optimizerDescriptor =
  withObjCPtr optimizerDescriptor $ \raw_optimizerDescriptor ->
      sendMsg mpsnnOptimizerAdam (mkSelector "initWithDevice:beta1:beta2:epsilon:timeStep:optimizerDescriptor:") (retPtr retVoid) [argPtr (castPtr (unRawId device) :: Ptr ()), argCDouble beta1, argCDouble beta2, argCFloat epsilon, argCULong timeStep, argPtr (castPtr raw_optimizerDescriptor :: Ptr ())] >>= ownedObject . castPtr
...
setTimeStep mpsnnOptimizerAdam  value =
    sendMsg mpsnnOptimizerAdam (mkSelector "setTimeStep:") retVoid [argCULong value]
