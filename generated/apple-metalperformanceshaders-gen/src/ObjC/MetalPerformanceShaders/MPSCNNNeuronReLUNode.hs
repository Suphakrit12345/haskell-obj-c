...
nodeWithSource_a sourceNode a =
  do
    ...
    withObjCPtr sourceNode $ \raw_sourceNode ->
      sendClassMsg cls' (mkSelector "nodeWithSource:a:") (retPtr retVoid) [argPtr (castPtr raw_sourceNode :: Ptr ()), argCFloat a] >>= retainedObject . castPtr
...
initWithSource_a mpscnnNeuronReLUNode  sourceNode a =
  withObjCPtr sourceNode $ \raw_sourceNode ->
      sendMsg mpscnnNeuronReLUNode (mkSelector "initWithSource:a:") (retPtr retVoid) [argPtr (castPtr raw_sourceNode :: Ptr ()), argCFloat a] >>= ownedObject . castPtr
