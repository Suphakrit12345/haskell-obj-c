...
nodeWithSource_integerScaleFactorX_integerScaleFactorY_alignCorners sourceNode integerScaleFactorX integerScaleFactorY alignCorners =
  do
    cls' <- getRequiredClass "MPSCNNUpsamplingBilinearNode"
    withObjCPtr sourceNode $ \raw_sourceNode ->
      sendClassMsg cls' (mkSelector "nodeWithSource:integerScaleFactorX:integerScaleFactorY:alignCorners:") (retPtr retVoid) [argPtr (castPtr raw_sourceNode :: Ptr ()), argCULong integerScaleFactorX, argCULong integerScaleFactorY, argCULong (if alignCorners then 1 else 0)] >>= retainedObject . castPtr
...
initWithSource_integerScaleFactorX_integerScaleFactorY mpscnnUpsamplingBilinearNode  sourceNode integerScaleFactorX integerScaleFactorY =
  withObjCPtr sourceNode $ \raw_sourceNode ->
      sendMsg mpscnnUpsamplingBilinearNode (mkSelector "initWithSource:integerScaleFactorX:integerScaleFactorY:") (retPtr retVoid) [argPtr (castPtr raw_sourceNode :: Ptr ()), argCULong integerScaleFactorX, argCULong integerScaleFactorY] >>= ownedObject . castPtr
...
initWithSource_integerScaleFactorX_integerScaleFactorY_alignCorners mpscnnUpsamplingBilinearNode  sourceNode integerScaleFactorX integerScaleFactorY alignCorners =
  withObjCPtr sourceNode $ \raw_sourceNode ->
      sendMsg mpscnnUpsamplingBilinearNode (mkSelector "initWithSource:integerScaleFactorX:integerScaleFactorY:alignCorners:") (retPtr retVoid) [argPtr (castPtr raw_sourceNode :: Ptr ()), argCULong integerScaleFactorX, argCULong integerScaleFactorY, argCULong (if alignCorners then 1 else 0)] >>= ownedObject . castPtr
