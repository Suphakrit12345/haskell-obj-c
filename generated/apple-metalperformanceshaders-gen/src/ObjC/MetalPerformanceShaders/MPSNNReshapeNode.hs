...
nodeWithSource_resultWidth_resultHeight_resultFeatureChannels source resultWidth resultHeight resultFeatureChannels =
  do
    ...
    withObjCPtr source $ \raw_source ->
      sendClassMsg cls' (mkSelector "nodeWithSource:resultWidth:resultHeight:resultFeatureChannels:") (retPtr retVoid) [argPtr (castPtr raw_source :: Ptr ()), argCULong resultWidth, argCULong resultHeight, argCULong resultFeatureChannels] >>= retainedObject . castPtr
...
initWithSource_resultWidth_resultHeight_resultFeatureChannels mpsnnReshapeNode  source resultWidth resultHeight resultFeatureChannels =
  withObjCPtr source $ \raw_source ->
      sendMsg mpsnnReshapeNode (mkSelector "initWithSource:resultWidth:resultHeight:resultFeatureChannels:") (retPtr retVoid) [argPtr (castPtr raw_source :: Ptr ()), argCULong resultWidth, argCULong resultHeight, argCULong resultFeatureChannels] >>= ownedObject . castPtr
