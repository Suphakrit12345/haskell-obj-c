...
initWithDevice_kernelWidth_kernelHeight mpscnnPooling  device kernelWidth kernelHeight =
    sendMsg mpscnnPooling (mkSelector "initWithDevice:kernelWidth:kernelHeight:") (retPtr retVoid) [argPtr (castPtr (unRawId device) :: Ptr ()), argCULong kernelWidth, argCULong kernelHeight] >>= ownedObject . castPtr
...
initWithDevice_kernelWidth_kernelHeight_strideInPixelsX_strideInPixelsY mpscnnPooling  device kernelWidth kernelHeight strideInPixelsX strideInPixelsY =
    sendMsg mpscnnPooling (mkSelector "initWithDevice:kernelWidth:kernelHeight:strideInPixelsX:strideInPixelsY:") (retPtr retVoid) [argPtr (castPtr (unRawId device) :: Ptr ()), argCULong kernelWidth, argCULong kernelHeight, argCULong strideInPixelsX, argCULong strideInPixelsY] >>= ownedObject . castPtr
