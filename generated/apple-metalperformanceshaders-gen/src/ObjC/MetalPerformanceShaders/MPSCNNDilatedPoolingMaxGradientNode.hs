    ...
    withObjCPtr sourceGradient $ \raw_sourceGradient ->
      withObjCPtr sourceImage $ \raw_sourceImage ->
        withObjCPtr gradientState $ \raw_gradientState ->
          sendClassMsg cls' (mkSelector "nodeWithSourceGradient:sourceImage:gradientState:kernelWidth:kernelHeight:strideInPixelsX:strideInPixelsY:dilationRateX:dilationRateY:") (retPtr retVoid) [argPtr (castPtr raw_sourceGradient :: Ptr ()), argPtr (castPtr raw_sourceImage :: Ptr ()), argPtr (castPtr raw_gradientState :: Ptr ()), argCULong kernelWidth, argCULong kernelHeight, argCULong strideInPixelsX, argCULong strideInPixelsY, argCULong dilationRateX, argCULong dilationRateY] >>= retainedObject . castPtr
...
initWithSourceGradient_sourceImage_gradientState_kernelWidth_kernelHeight_strideInPixelsX_strideInPixelsY_dilationRateX_dilationRateY mpscnnDilatedPoolingMaxGradientNode  sourceGradient sourceImage gradientState kernelWidth kernelHeight strideInPixelsX strideInPixelsY dilationRateX dilationRateY =
  withObjCPtr sourceGradient $ \raw_sourceGradient ->
    withObjCPtr sourceImage $ \raw_sourceImage ->
      withObjCPtr gradientState $ \raw_gradientState ->
          sendMsg mpscnnDilatedPoolingMaxGradientNode (mkSelector "initWithSourceGradient:sourceImage:gradientState:kernelWidth:kernelHeight:strideInPixelsX:strideInPixelsY:dilationRateX:dilationRateY:") (retPtr retVoid) [argPtr (castPtr raw_sourceGradient :: Ptr ()), argPtr (castPtr raw_sourceImage :: Ptr ()), argPtr (castPtr raw_gradientState :: Ptr ()), argCULong kernelWidth, argCULong kernelHeight, argCULong strideInPixelsX, argCULong strideInPixelsY, argCULong dilationRateX, argCULong dilationRateY] >>= ownedObject . castPtr
