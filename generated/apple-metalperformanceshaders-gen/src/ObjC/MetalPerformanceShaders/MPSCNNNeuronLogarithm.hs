...
initWithDevice_a_b_c mpscnnNeuronLogarithm  device a b c =
    sendMsg mpscnnNeuronLogarithm (mkSelector "initWithDevice:a:b:c:") (retPtr retVoid) [argPtr (castPtr (unRawId device) :: Ptr ()), argCFloat a, argCFloat b, argCFloat c] >>= ownedObject . castPtr
