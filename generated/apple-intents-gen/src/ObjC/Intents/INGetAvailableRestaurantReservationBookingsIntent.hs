...
setPartySize inGetAvailableRestaurantReservationBookingsIntent  value =
    sendMsg inGetAvailableRestaurantReservationBookingsIntent (mkSelector "setPartySize:") retVoid [argCULong value]
