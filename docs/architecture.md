...
This document describes the internal structure of `haskell-obj-c` — how the
runtime library, codegen, C stubs, and generated bindings fit together.
...
- **Vtable-based dynamic classes.** Haskell-backed ObjC classes use a per-instance
  ...
  [dynclass.md](dynclass.md) for details.
